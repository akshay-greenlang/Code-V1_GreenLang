@echo off
REM Setup pip cache and create offline wheel directory for greenlang-cli (Windows)

echo GreenLang CLI - Cache Setup
echo ============================
echo.

REM Show current pip cache location
...
REM Download all dependencies to wheels directory
