...
Ingestion Pipeline ......... DONE (framework + 9 parsers: CBAM, DEFRA, EPA, eGRID, IPCC, GHG Protocol, TCR, Green-e + framework)
ETL Normalization .......... DONE (canonical schema + content hashing)
Quality Gates (Q1-Q6) ...... DONE (validators, batch QA, dedup, cross-source, license scanner, review workflow, promotion)
Approval Gates (G5-G6) ..... DONE (legal, export, certification)
Catalog Repository ......... DONE (SQLite + Memory + Postgres, editions, search)
Matching Pipeline .......... DONE (hybrid: lexical 40% + semantic 60% + RRF + optional LLM rerank)
Watch Engine ............... DONE (monitoring, classification, changelog, scheduler, release orchestrator)
API Layer .................. DONE (8+ endpoints: search, search_v2, export, diff, audit-bundle, tier enforcement, ETag caching)
DB Migrations .............. DONE (V426-V430, Postgres + SQLite parity)
SDK (Python) ............... DONE (full typed HTTP client: 20+ methods, retry logic, FactorsClient)
SDK (TypeScript) ........... DONE (full typed client: Node.js + browser, @greenlang/factors-sdk)
Tenant Overlay ............. STUB (enterprise multi-tenancy)
Cron/Scheduler ............. DONE (watch scheduler + release orchestrator + CLI commands)
CI/CD Integration .......... DONE (factors-tests.yml: lint, typecheck, unit tests, match eval, registry validation, migration check)
Pre-commit Hooks ........... DONE (factors-lint, factors-typecheck, factors-validate-registry, factors-manifest-check)
Monitoring/Prometheus ...... MISSING (in-process counters only)
Postgres Repository ........ DONE (full async psycopg impl with tsvector search, all 10 abstract methods)
Developer Docs ............. DONE (quickstart, auth, edition pinning, search cookbook, match API, audit bundle, rate limiting, errors, changelog)
```
