...
class EmissionFactorDatabase:
    ...
    def insert_factor(self, factor: EmissionFactor) -> None:
        ...
        """, (
            ...
            factor.unit,
            FinancialDecimal.from_string(factor.factor_co2),
            FinancialDecimal.from_string(factor.factor_ch4) if factor.factor_ch4 else None,
            FinancialDecimal.from_string(factor.factor_n2o) if factor.factor_n2o else None,
            FinancialDecimal.from_string(factor.factor_co2e),
            factor.region,
