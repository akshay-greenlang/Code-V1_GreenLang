...
feedback trends and experiment performance for GL-003 SteamSystemAnalyzer.
...
class FeedbackMetrics:
    ...
    def _define_metrics(self) -> None:
        ...
        self.feedback_accuracy_avg = Gauge(
            'gl003_feedback_accuracy_average',
        ...
        self.feedback_processing_time = Histogram(
            'gl003_feedback_processing_seconds',
        ...
        self.experiments_active = Gauge(
            'gl003_experiments_active',
            'Number of active experiments',
            registry=self.registry
        )

        self.experiment_users = Gauge(
            'gl003_experiment_users_total',
        ...
        self.experiment_conversion_rate = Gauge(
            'gl003_experiment_conversion_rate',
