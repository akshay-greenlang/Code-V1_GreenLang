...
class CondensateOptimizer:
    ...
    def optimize_condensate_system(
        ...
        return CondensateResults(
            ...
            total_recovery_potential_gj_hr=FinancialDecimal.from_string(total_recovery),
            current_return_rate_percent=data.return_rate_percent,
            optimal_return_rate_percent=FinancialDecimal.from_string(optimal_return),
    ...
    def _calculate_flash_steam(
        ...
        return {
            ...
            'flash_rate_kg_hr': FinancialDecimal.from_string(m_flash),
    ...
    def _size_flash_vessel(
        ...
        return {
            ...
            'design_pressure_bar': FinancialDecimal.from_string(P * Decimal('1.5'))  # Safety factor
        }
