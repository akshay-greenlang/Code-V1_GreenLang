...
class HeatTransferCalculator:
    ...
    def calculate_heat_transfer_efficiency(self, data: HeatTransferData) -> Dict:
        ...
        result = {
            ...
            'fouling_factor_m2_k_w': FinancialDecimal.from_string(fouling_factor),
            'heat_transfer_rate_kw': FinancialDecimal.from_string(heat_transfer),
    ...
    def _detect_fouling(self, fouling_factor: Decimal, operating_hours: float) -> Dict:
        ...
        R_f = FinancialDecimal.from_string(fouling_factor)
