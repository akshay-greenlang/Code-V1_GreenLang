...
class SteamGenerationCalculator:
    ...
    def calculate_steam_generation_efficiency(
        ...
        result = {
            ...
            'specific_fuel_consumption_kg_fuel_per_tonne_steam': FinancialDecimal.from_string(specific_consumption),
    ...
    def optimize_pressure_temperature_control(
        ...
        result = {
            ...
            'transition_time_minutes': FinancialDecimal.from_string(total_transition_time),
    ...
    def _calculate_thermal_stress(
        ...
        indicators = {
            ...
            'pressure_stress_factor': FinancialDecimal.from_string(stress_factor),
            'thermal_cycling_risk': cycling_risk,
            'tube_life_factor': FinancialDecimal.from_string(Decimal('1') - stress_factor * Decimal('0.1'))
        }
    ...
    def _identify_optimization_opportunities(
        ...
        if Decimal(str(data.blowdown_rate_percent)) > Decimal('3'):
            opportunities.append({
                ...
                'current_percent': FinancialDecimal.from_string(data.blowdown_rate_percent),
                'target_percent': 2.0,
