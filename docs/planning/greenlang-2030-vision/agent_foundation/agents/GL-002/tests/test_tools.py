...
def historical_data():
    ...
    base_time = DeterministicClock.now() - timedelta(days=30)
    data = []
...
class TestProvenanceTracker:
    ...
    def test_audit_trail_generation(self, provenance_tracker):
        ...
        operations = [
            {"operation": "read", "source": "SCADA", "timestamp": DeterministicClock.now()},
            {"operation": "calculate", "method": "efficiency", "timestamp": DeterministicClock.now()},
            {"operation": "write", "destination": "ERP", "timestamp": DeterministicClock.now()},
        ]
...
class TestDataValidator:
    ...
    def test_temporal_validation(self, data_validator):
        ...
        time_series = [
            {"timestamp": DeterministicClock.now() - timedelta(hours=2), "value": 100},
            {"timestamp": DeterministicClock.now() - timedelta(hours=1), "value": 105},
            {"timestamp": DeterministicClock.now(), "value": 110},
        ]
