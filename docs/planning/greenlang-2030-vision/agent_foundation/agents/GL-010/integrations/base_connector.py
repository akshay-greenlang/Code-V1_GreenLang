"""
Base Connector Module for GL-010 EMISSIONWATCH (EmissionsComplianceAgent).

Provides abstract base class with common functionality for all emissions monitoring
and regulatory reporting connectors including connection pooling, retry logic,
...
class BaseConnector(ABC):
    """
    Abstract base class for all emissions monitoring connectors.
