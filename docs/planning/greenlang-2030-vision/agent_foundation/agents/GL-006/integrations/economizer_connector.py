...
class PerformanceMonitor:
    ...
    def __init__(self, baseline_efficiency: float = 90.0):
        ...
        self.last_cleaning: datetime = DeterministicClock.now()
    ...
    def get_degradation_rate(self) -> float:
        ...
        cutoff = DeterministicClock.now() - timedelta(hours=24)
...
class ModbusEconomizerClient:
    ...
    def _get_mock_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'condensate_flow': 50.0 if deterministic_random().random() > 0.5 else 0,
