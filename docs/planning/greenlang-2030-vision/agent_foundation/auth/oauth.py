...
class TokenBlacklist:
    ...
    def is_blacklisted(self, jti: str) -> bool:
        ...
        if self._expiration.get(jti, DeterministicClock.utcnow()) < DeterministicClock.utcnow():
...
class PublicKeyCache:
    ...
    def get(self, provider: str, key_id: str) -> Optional[str]:
        ...
        # Check if expired
        if (DeterministicClock.utcnow() - self._timestamps[cache_key]).total_seconds() > self._ttl:
    ...
    def set(self, provider: str, key_id: str, public_key: str) -> None:
        ...
        self._timestamps[cache_key] = DeterministicClock.utcnow()
