...
class IoTDataIngestionPipeline:
    ...
    def _setup_mqtt_client(self) -> mqtt.Client:
        ...
        client = mqtt.Client(client_id=f"greenlang-ingestion-{DeterministicClock.now().timestamp()}")
    ...
    def _on_message(self, client, userdata, msg):
        ...
        try:
            ...
            enriched_message = {
                ...
                'timestamp': payload.get('timestamp', DeterministicClock.now().isoformat()),
    ...
    async def _trigger_alert(self, alert_data: Dict):
        ...
        alert = {
            'alert_id': f"alert_{DeterministicClock.now().timestamp()}",
        ...
        point = Point("alerts") \
            ...
            .time(DeterministicClock.utcnow())
    ...
    def _update_device_status(self, message: Dict):
        ...
        self.device_registry[device_id].update({
            'last_seen': DeterministicClock.now(),
