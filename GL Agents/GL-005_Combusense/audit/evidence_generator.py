"""
Immutable Evidence Pack Generator for GL-005 COMBUSENSE
...
class EvidenceType(Enum):
    ...
    EMISSIONS_READING = "EMISSIONS_READING"
    O2_TRIM_ADJUSTMENT = "O2_TRIM_ADJUSTMENT"
...
class EvidencePackMetadata(BaseModel):
    ...
    regulatory_frameworks: List[str] = Field(default_factory=lambda: ["EPA_40_CFR_60", "EPA_40_CFR_98", "ISO_50001_2018"])
