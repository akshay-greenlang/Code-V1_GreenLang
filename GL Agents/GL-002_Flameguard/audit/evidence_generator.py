"""
Immutable Evidence Pack Generator for GL-002 FLAMEGUARD
...
class EvidenceType(Enum):
    ...
    FLAME_MONITORING = "FLAME_MONITORING"
    COMBUSTION_ADJUSTMENT = "COMBUSTION_ADJUSTMENT"
    BOILER_TUNING = "BOILER_TUNING"
...
class EvidencePackMetadata(BaseModel):
    ...
    regulatory_frameworks: List[str] = Field(default_factory=lambda: ["EPA_40_CFR_98", "ISO_50001_2018", "NFPA_85"])
