#!/usr/bin/env python3
"""
Setup script for GL-004 BURNMASTER
...
setup(
    ...
    version=get_version(),
    description="GL-004 BURNMASTER: Burner Optimization Agent for Combustion Control",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    author="GreenLang Team",
    author_email="team@greenlang.io",
    url="https://github.com/greenlang/gl004-burnmaster",
    project_urls={
        "Documentation": "https://docs.greenlang.io/gl004",
        "Source": "https://github.com/greenlang/gl004-burnmaster",
    ...
    entry_points={
        "console_scripts": [
            "gl004=GL_Agents.GL004_Burnmaster.cli:main",
            "gl004-server=GL_Agents.GL004_Burnmaster.server:main",
        ],
    },
    zip_safe=False,
)
