# -*- coding: utf-8 -*-
"""
Pack041Bridge - PACK-041 Scope 1-2 Emissions Import for PACK-047
===================================================================

Retrieves Scope 1 and Scope 2 emission totals from PACK-041 (Scope 1-2
Complete Pack) for use as the emissions data in GHG benchmarking.
Returns location-based AND market-based Scope 2 values separately,
supports period alignment to the benchmark reporting period, and
provides gas breakdown for GWP version alignment.
...
Integration Points:
    ...
    - Gas breakdown for GWP version alignment (AR4, AR5, AR6)
...
class GasBreakdown(BaseModel):
    """Gas-level breakdown for GWP version alignment."""
...
class Pack041Bridge:
    ...
    breakdown, dual Scope 2 reporting (location-based and market-based),
    gas-level breakdown for GWP alignment, and period alignment for
    ...
    async def get_gas_breakdown(self, period: str) -> GasBreakdown:
        """Retrieve gas-level breakdown for GWP version alignment.
