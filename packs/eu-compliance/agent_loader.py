...
AGENT_REGISTRY: Dict[str, AgentEntry] = {
    ...
    "GL-DATA-X-005": AgentEntry(
        ...
        module_path="greenlang.agents.data.eudr_traceability",
        category="data",
        description="EUDR Traceability Connector",
    ),
    "GL-DATA-X-006": AgentEntry(
        agent_id="GL-DATA-X-006",
        module_path="greenlang.agents.data.gis_connector",
        category="data",
    ...
    "GL-DATA-X-008": AgentEntry(
        ...
        module_path="greenlang.agents.data.supplier_questionnaire",
        category="data",
