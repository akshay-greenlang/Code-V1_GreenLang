...
def get_service():
    ...
    if _service_instance is None:
        try:
            from greenlang.business_travel.service import BusinessTravelService
            _service_instance = BusinessTravelService()
            logger.info("BusinessTravelService initialized successfully")
        except Exception as e:
            logger.error(f"Failed to initialize BusinessTravelService: {e}")
            raise HTTPException(
...
async def calculate_flight_emissions(
    ...
    try:
        ...
        logger.error(f"Validation error in calculate_flight_emissions: {e}")
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail=str(e),
        )
...
async def calculate_rail_emissions(
    ...
    try:
        ...
        logger.error(f"Validation error in calculate_rail_emissions: {e}")
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail=str(e),
        )
...
async def calculate_road_emissions(
    ...
    try:
        ...
        logger.error(f"Validation error in calculate_road_emissions: {e}")
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail=str(e),
        )
...
async def calculate_hotel_emissions(
    ...
    try:
        ...
        logger.error(f"Validation error in calculate_hotel_emissions: {e}")
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail=str(e),
        )
...
async def search_airports(
    ...
    try:
        ...
        logger.error(f"Error in search_airports: {e}", exc_info=True)
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def list_transport_modes(
    ...
    try:
        ...
        logger.error(f"Error in list_transport_modes: {e}", exc_info=True)
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def list_cabin_classes(
    ...
    try:
        ...
        logger.error(f"Error in list_cabin_classes: {e}", exc_info=True)
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
...
async def analyze_hot_spots(
    ...
    try:
        ...
        logger.error(f"Validation error in analyze_hot_spots: {e}")
        raise HTTPException(
            status_code=status.HTTP_400_BAD_REQUEST,
            detail=str(e),
        )
    except Exception as e:
        logger.error(f"Error in analyze_hot_spots: {e}", exc_info=True)
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
