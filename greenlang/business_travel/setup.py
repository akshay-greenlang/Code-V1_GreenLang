...
Example:
    >>> from greenlang.business_travel.setup import get_service
    >>> service = get_service()
...
Integration:
    >>> from greenlang.business_travel.setup import get_router
...
class BusinessTravelService:
    ...
    def calculate(self, request: TripCalculationRequest) -> TripCalculationResponse:
        ...
        try:
            from greenlang.business_travel.models import TransportMode, TripInput, TripPurpose
    ...
    def analyze_uncertainty(self, request: UncertaintyRequest) -> UncertaintyResponse:
        ...
        from greenlang.business_travel.models import UNCERTAINTY_RANGES, DataQualityTier
    ...
    def get_airports(self, query: str = "") -> List[AirportInfo]:
        ...
        """
        from greenlang.business_travel.models import AIRPORT_DATABASE
    ...
    def get_cabin_classes(self) -> List[CabinClassInfo]:
        ...
        """
        from greenlang.business_travel.models import CABIN_CLASS_MULTIPLIERS, CabinClass
...
def get_router():
    ...
    """
    from greenlang.business_travel.api.router import router
    return router
