...
Provides SHA-256 based audit trail tracking for all spend categorization
...
Example:
    ...
    >>> entry_id = tracker.record("spend_record", "rec_001", "ingest", "abc123")
...
class ProvenanceTracker:
    """Tracks provenance for spend categorizer operations with SHA-256 chain hashing.
    ...
    _GENESIS_HASH = hashlib.sha256(b"greenlang-spend-categorizer-genesis").hexdigest()
