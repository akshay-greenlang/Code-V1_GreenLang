...
Example:
    >>> from greenlang.dual_reporting_reconciliation.trend_analysis import (
    ...     TrendAnalysisEngine,
    ... )
    >>> engine = TrendAnalysisEngine()
    >>> from greenlang.dual_reporting_reconciliation.models import TrendDataPoint
    >>> points = [
    ...     TrendDataPoint(
...
try:
    ...
    logger.warning(
        "greenlang.dual_reporting_reconciliation.models not available; "
