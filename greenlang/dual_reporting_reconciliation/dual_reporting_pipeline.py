...
from greenlang.dual_reporting_reconciliation.config import DualReportingReconciliationConfig
from greenlang.dual_reporting_reconciliation.metrics import DualReportingReconciliationMetrics
from greenlang.dual_reporting_reconciliation.provenance import DualReportingReconciliationProvenance
...
class DualReportingPipelineEngine:
    ...
    def _get_quality_scorer(self):
        ...
        if self._quality_scorer is None:
            from greenlang.dual_reporting_reconciliation.quality_scorer import QualityScorerEngine
    ...
    def _get_trend_analyzer(self):
        ...
        if self._trend_analyzer is None:
            from greenlang.dual_reporting_reconciliation.trend_analyzer import TrendAnalysisEngine
