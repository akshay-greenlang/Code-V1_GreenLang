...
def __getattr__(name: str):
    ...
    _exports = {
        # Engines
        "DualResultCollectorEngine": "greenlang.dual_reporting_reconciliation.dual_result_collector",
        "DiscrepancyAnalyzerEngine": "greenlang.dual_reporting_reconciliation.discrepancy_analyzer",
        "QualityScorerEngine": "greenlang.dual_reporting_reconciliation.quality_scorer",
        "ReportingTableGeneratorEngine": "greenlang.dual_reporting_reconciliation.reporting_table_generator",
        "TrendAnalysisEngine": "greenlang.dual_reporting_reconciliation.trend_analyzer",
        "ComplianceCheckerEngine": "greenlang.dual_reporting_reconciliation.compliance_checker",
        "DualReportingPipelineEngine": "greenlang.dual_reporting_reconciliation.dual_reporting_pipeline",
        # Core singletons
        "DualReportingReconciliationConfig": "greenlang.dual_reporting_reconciliation.config",
        "DualReportingReconciliationMetrics": "greenlang.dual_reporting_reconciliation.metrics",
        "DualReportingReconciliationProvenance": "greenlang.dual_reporting_reconciliation.provenance",
        # Service facade
        "DualReportingService": "greenlang.dual_reporting_reconciliation.setup",
        "get_service": "greenlang.dual_reporting_reconciliation.setup",
    }
    if name in _exports:
        import importlib
