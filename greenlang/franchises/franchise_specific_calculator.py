...
def _get_metrics() -> Any:
    ...
    try:
        from greenlang.franchises.franchise_database import get_metrics_collector
...
def _get_provenance() -> Any:
    ...
    try:
        from greenlang.franchises.franchise_database import get_provenance_manager
...
class FranchiseSpecificCalculatorEngine:
    ...
    def _validate_metered_data(
        ...
        from greenlang.franchises.franchise_database import FRANCHISE_TYPES
