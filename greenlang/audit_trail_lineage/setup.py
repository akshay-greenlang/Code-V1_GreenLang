...
Example:
    >>> from greenlang.audit_trail_lineage.setup import get_service
    >>> service = get_service()
...
Integration:
    >>> from greenlang.audit_trail_lineage.setup import get_router
    >>> app.include_router(get_router(), prefix="/api/v1/audit-trail-lineage")

Module: greenlang.audit_trail_lineage.setup
Agent: AGENT-MRV-030
