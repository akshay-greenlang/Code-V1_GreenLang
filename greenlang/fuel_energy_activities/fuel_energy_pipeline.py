...
try:
    from greenlang.fuel_energy_activities.metrics import FuelEnergyMetricsCollector
except ImportError:
    FuelEnergyMetricsCollector = None  # type: ignore[assignment, misc]

try:
    from greenlang.fuel_energy_activities.provenance import ProvenanceTracker
except ImportError:
...
try:
    from greenlang.fuel_energy_activities.upstream_fuel_calculator import (
...
try:
    from greenlang.fuel_energy_activities.upstream_electricity_calculator import (
...
try:
    from greenlang.fuel_energy_activities.dqi_assessor import (
        DQIAssessorEngine,
    )
except ImportError:
