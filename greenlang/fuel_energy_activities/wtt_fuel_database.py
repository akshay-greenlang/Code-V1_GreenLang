...
Example:
    >>> from greenlang.fuel_energy_activities.wtt_fuel_database import WTTFuelDatabaseEngine
...
from greenlang.fuel_energy_activities.provenance import get_provenance
...
def get_wtt_fuel_database(
    ...
    Example:
        >>> from greenlang.fuel_energy_activities.wtt_fuel_database import (
