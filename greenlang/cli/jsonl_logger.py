...
class JSONLLogger:
    ...
    def log_step_complete(self, step_name: str, success: bool, duration: float, **kwargs):
        """Log step completion event"""
        return self.log_event("step_complete", {
            "step_name": step_name,
            "success": success,
    ...
    def log_complete(self, run_id: str, success: bool, **kwargs):
        ...
        return self.log_event("complete", {
            "run_id": run_id,
            "success": success,
    ...
    def log_validation(self, validation_type: str, passed: bool, details: Optional[Dict] = None):
        """Log validation result"""
        return self.log_event("validation", {
    ...
    @staticmethod
    def filter_events(events: list, event_type: Optional[str] = None, 
