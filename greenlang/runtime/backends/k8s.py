...
from .base import (
    Backend, ExecutionContext, Pipeline, PipelineStep,
...
class KubernetesBackend(Backend):
    ...
    def _create_job(self, step: PipelineStep, pipeline: Pipeline, 
    ...
    def _create_workflow(self, pipeline: Pipeline, context: ExecutionContext) -> Dict[str, Any]:
        ...
        while len(completed_steps) < len(pipeline.steps):
            ...
            if not ready_steps:
                ...
                results["errors"].append("Dependency cycle detected or unsatisfiable dependencies")
                break
    ...
    def _wait_for_job(self, job_name: str, run_id: str, timeout: int = 3600) -> Dict[str, Any]:
    ...
    def _create_resource_requirements(self, step: PipelineStep) -> client.V1ResourceRequirements:
    ...
    def _create_volumes(self, volume_specs: List[Dict[str, Any]]) -> List[client.V1Volume]:
        """Create pod volumes"""
    ...
    def _create_volume_mounts(self, volume_specs: List[Dict[str, Any]]) -> List[client.V1VolumeMount]:
