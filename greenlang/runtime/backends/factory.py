...
class BackendFactory:
    ...
    @classmethod
    def create(cls, backend_type: str, config: Optional[Dict[str, Any]] = None) -> Backend:
        """
...
class BackendManager:
    ...
    def get_backend(self, backend_type: Optional[str] = None,
                   config: Optional[Dict[str, Any]] = None) -> Backend:
        """
    ...
    def execute_pipeline(self, pipeline, context, 
