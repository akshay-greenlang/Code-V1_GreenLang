...
class LocalBackend(Backend):
    ...
    def _run_step(self, step: PipelineStep, pipeline: Pipeline,
    ...
    def _run_workflow(self, pipeline: Pipeline, context: ExecutionContext) -> Dict[str, Any]:
        ...
        while len(completed_steps) < len(pipeline.steps):
            ...
            if not ready_steps:
                ...
                results["errors"].append("Dependency cycle or unsatisfiable dependencies")
                break
