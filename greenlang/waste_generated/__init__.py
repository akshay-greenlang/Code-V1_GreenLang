...
try:
    from greenlang.waste_generated.waste_classification_database import WasteClassificationDatabaseEngine
except ImportError:
...
try:
    from greenlang.waste_generated.incineration_emissions import IncinerationEmissionsEngine
except ImportError:
    IncinerationEmissionsEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.waste_generated.recycling_composting import RecyclingCompostingEngine
except ImportError:
    RecyclingCompostingEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.waste_generated.wastewater_emissions import WastewaterEmissionsEngine
except ImportError:
...
try:
    from greenlang.waste_generated.models import AGENT_ID, AGENT_COMPONENT, VERSION as MODELS_VERSION, TABLE_PREFIX
except ImportError:
...
try:
    from greenlang.waste_generated.config import get_config
except ImportError:
