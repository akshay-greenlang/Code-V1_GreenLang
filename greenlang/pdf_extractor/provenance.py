...
Provides SHA-256 based audit trail tracking for all PDF extraction
...
Example:
    ...
    >>> entry_id = tracker.record("document", "doc_001", "ingest", "abc123")
...
class ProvenanceTracker:
    """Tracks provenance for PDF extractor operations with SHA-256 chain hashing.
    ...
    _GENESIS_HASH = hashlib.sha256(b"greenlang-pdf-extractor-genesis").hexdigest()
    ...
    def record(
        ...
        Args:
            entity_type: Type of entity (document, extraction, template, etc.).
            entity_id: Unique entity identifier.
            action: Action performed (ingest, extract, classify, validate, etc.).
