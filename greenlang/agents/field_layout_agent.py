    ...
    def execute(self, input_data: Dict[str, Any]) -> AgentResult:
        ...
        try:
            ...
            if total_annual_demand_gwh is None or not solar_config:
                return AgentResult(success=False, error="total_annual_demand_gwh and solar_config must be provided")
            
            target_solar_fraction = 0.50  # For v1, we hardcode a 50% target
            
            # Calculate the total solar energy we need to generate in a year
            required_solar_energy_kwh = total_annual_demand_gwh * 1e6 * target_solar_fraction
            ...
            required_land_area_m2 = actual_aperture_area_m2 * land_area_per_aperture_area
