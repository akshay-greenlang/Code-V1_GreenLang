...
Example:
    >>> from greenlang.agents.foundation.observability_agent import ObservabilityAgentService
...
# Core engines
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.observability_agent.metrics_collector import MetricsCollector
from greenlang.agents.foundation.observability_agent.trace_manager import TraceManager
from greenlang.agents.foundation.observability_agent.log_aggregator import LogAggregator
from greenlang.agents.foundation.observability_agent.alert_evaluator import AlertEvaluator
from greenlang.agents.foundation.observability_agent.health_checker import HealthChecker
from greenlang.agents.foundation.observability_agent.dashboard_provider import DashboardProvider
from greenlang.agents.foundation.observability_agent.slo_tracker import SLOTracker
...
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.observability_agent.setup import (
