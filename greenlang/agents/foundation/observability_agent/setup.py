...
Usage:
    ...
    >>> from greenlang.agents.foundation.observability_agent.setup import configure_observability_agent
    >>> app = FastAPI()
    >>> import asyncio
...
from greenlang.agents.foundation.observability_agent.config import ObservabilityAgentConfig, get_config
...
async def configure_observability_agent(
    ...
    try:
        from greenlang.agents.foundation.observability_agent.api.router import (
...
def get_router() -> Any:
    ...
    """
    try:
        from greenlang.agents.foundation.observability_agent.api.router import router
        return router
    except ImportError:
        return None
