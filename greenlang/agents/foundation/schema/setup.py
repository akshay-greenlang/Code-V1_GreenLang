...
Usage:
    ...
    >>> from greenlang.agents.foundation.schema.setup import configure_schema_service
    >>> app = FastAPI()
...
from greenlang.agents.foundation.schema.metrics import (
...
def configure_schema_service(
    ...
    try:
        from greenlang.agents.foundation.schema.api.routes import router as schema_router
