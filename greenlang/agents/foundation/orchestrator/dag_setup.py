...
Usage:
    ...
    >>> from greenlang.agents.foundation.orchestrator.dag_setup import configure_dag_orchestrator
    >>> app = FastAPI()
...
from greenlang.agents.foundation.orchestrator.checkpoint_store import (
    DAGCheckpointStore,
    create_checkpoint_store,
)
from greenlang.agents.foundation.orchestrator.config import OrchestratorConfig, get_config
from greenlang.agents.foundation.orchestrator.dag_builder import DAGBuilder
from greenlang.agents.foundation.orchestrator.dag_executor import (
    DAGExecutor,
    ExecutionOptions,
)
...
def configure_dag_orchestrator(
    ...
    # Mount DAG router
    try:
        from greenlang.agents.foundation.orchestrator.api.dag_router import dag_router
