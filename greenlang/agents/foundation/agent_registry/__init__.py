...
Example:
    >>> from greenlang.agents.foundation.agent_registry import AgentRegistry, AgentMetadataEntry
    >>> r = AgentRegistry()
    >>> # Register, query, health-check, resolve dependencies...

    >>> from greenlang.agents.foundation.agent_registry import AgentRegistryService
...
# Configuration
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.agent_registry.config import (
    AgentRegistryConfig,
    get_config,
    set_config,
    reset_config,
...
from greenlang.agents.foundation.agent_registry.provenance import ProvenanceTracker, ProvenanceEntry

# ---------------------------------------------------------------------------
# Metrics
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.agent_registry.metrics import (
...
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.agent_registry.setup import (
