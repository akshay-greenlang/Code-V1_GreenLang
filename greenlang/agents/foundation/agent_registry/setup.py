...
Usage:
    ...
    >>> from greenlang.agents.foundation.agent_registry.setup import configure_agent_registry
    >>> app = FastAPI()
...
from greenlang.agents.foundation.agent_registry.registry import AgentRegistry
from greenlang.agents.foundation.agent_registry.health_checker import HealthChecker
from greenlang.agents.foundation.agent_registry.dependency_resolver import DependencyResolver
from greenlang.agents.foundation.agent_registry.capability_matcher import CapabilityMatcher
from greenlang.agents.foundation.agent_registry.provenance import ProvenanceTracker
from greenlang.agents.foundation.agent_registry.metrics import PROMETHEUS_AVAILABLE
...
class AgentRegistryService:
    ...
    def get_service_catalog(self) -> List[Dict[str, Any]]:
        ...
        """
        from greenlang.agents.foundation.agent_registry.models import ServiceCatalogEntry
...
def configure_agent_registry(
    ...
    # Mount API router
    try:
        from greenlang.agents.foundation.agent_registry.api.router import router as registry_router
...
def get_router() -> Any:
    ...
    """
    try:
        from greenlang.agents.foundation.agent_registry.api.router import router
        return router
    except ImportError:
        return None
