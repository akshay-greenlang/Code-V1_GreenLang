...
Usage:
    ...
    >>> from greenlang.agents.foundation.qa_test_harness.setup import configure_qa_test_harness
    >>> app = FastAPI()
    >>> import asyncio
...
from greenlang.agents.foundation.qa_test_harness.config import QATestHarnessConfig, get_config
from greenlang.agents.foundation.qa_test_harness.assertion_engine import AssertionEngine
from greenlang.agents.foundation.qa_test_harness.test_runner import TestRunner
from greenlang.agents.foundation.qa_test_harness.golden_file_manager import GoldenFileManager
from greenlang.agents.foundation.qa_test_harness.regression_detector import RegressionDetector
from greenlang.agents.foundation.qa_test_harness.performance_benchmarker import PerformanceBenchmarker
from greenlang.agents.foundation.qa_test_harness.coverage_tracker import CoverageTracker
from greenlang.agents.foundation.qa_test_harness.report_generator import ReportGenerator
from greenlang.agents.foundation.qa_test_harness.provenance import ProvenanceTracker
...
from greenlang.agents.foundation.qa_test_harness.metrics import (
...
async def configure_qa_test_harness(
    ...
    try:
        from greenlang.agents.foundation.qa_test_harness.api.router import router as qa_router
...
def get_router() -> Any:
    ...
    """
    try:
        from greenlang.agents.foundation.qa_test_harness.api.router import router
        return router
    except ImportError:
        return None
