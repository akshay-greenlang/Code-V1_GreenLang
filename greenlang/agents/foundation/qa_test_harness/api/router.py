...
if FASTAPI_AVAILABLE:
    ...
    async def run_test(
        ...
        try:
            from greenlang.agents.foundation.qa_test_harness.models import TestCaseInput, TestCategory
    ...
    async def run_suite(
        ...
        service = _get_service(request)
        try:
            from greenlang.agents.foundation.qa_test_harness.models import TestSuiteInput, TestCaseInput
    ...
    async def generate_report(
        ...
        service = _get_service(request)
        try:
            from greenlang.agents.foundation.qa_test_harness.models import TestSuiteResult
