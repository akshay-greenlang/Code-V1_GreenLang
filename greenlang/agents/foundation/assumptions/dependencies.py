...
from greenlang.agents.foundation.assumptions.models import DependencyNode
from greenlang.agents.foundation.assumptions.metrics import record_dependency_depth
