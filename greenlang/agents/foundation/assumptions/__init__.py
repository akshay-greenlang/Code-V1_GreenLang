...
Example:
    >>> from greenlang.agents.foundation.assumptions import AssumptionRegistry
    ...
    >>> from greenlang.agents.foundation.assumptions import ScenarioManager
    >>> s = ScenarioManager()
    >>> scenarios = s.list()
...
# Configuration
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.assumptions.config import (
    AssumptionsConfig,
    get_config,
    set_config,
    reset_config,
...
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.assumptions.models import (
    # Enumerations
    AssumptionDataType,
    AssumptionCategory,
    ScenarioType,
...
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.assumptions.setup import (
    AssumptionsService,
