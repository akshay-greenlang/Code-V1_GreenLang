...
Example:
    >>> from greenlang.agents.foundation.normalizer import UnitConverter
    >>> c = UnitConverter()
    >>> r = c.convert(100, "kWh", "MWh")
    >>> print(r.converted_value)  # Decimal('0.1')

    >>> from greenlang.agents.foundation.normalizer import EntityResolver
    >>> r = EntityResolver()
...
# Configuration
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.normalizer.config import (
    NormalizerConfig,
    get_config,
    set_config,
    reset_config,
...
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.normalizer.models import (
    # Enumerations
    UnitDimension,
    GHGGas,
    GWPVersion,
...
# Core engines
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.normalizer.converter import (
    UnitConverter,
    MASS_UNITS,
    ENERGY_UNITS,
    VOLUME_UNITS,
...
from greenlang.agents.foundation.normalizer.entity_resolver import (
    EntityResolver,
...
from greenlang.agents.foundation.normalizer.dimensional import DimensionalAnalyzer

from greenlang.agents.foundation.normalizer.provenance import ConversionProvenanceTracker

# ---------------------------------------------------------------------------
# Metrics
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.normalizer.metrics import (
...
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.normalizer.setup import (
    NormalizerService,
