...
Usage:
    ...
    >>> from greenlang.agents.foundation.normalizer.setup import configure_normalizer_service
    >>> app = FastAPI()
...
from greenlang.agents.foundation.normalizer.config import NormalizerConfig, get_config
from greenlang.agents.foundation.normalizer.converter import UnitConverter
...
from greenlang.agents.foundation.normalizer.metrics import PROMETHEUS_AVAILABLE
...
def configure_normalizer_service(
    ...
    try:
        from greenlang.agents.foundation.normalizer.api.router import router as normalizer_router
