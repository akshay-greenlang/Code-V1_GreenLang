...
Example:
    >>> from greenlang.agents.foundation.citations import CitationRegistry
    >>> r = CitationRegistry()
    >>> c = r.create(
    ...
    >>> from greenlang.agents.foundation.citations import EvidenceManager
    >>> em = EvidenceManager()
...
# Configuration
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.citations.config import (
    CitationsConfig,
    get_config,
    set_config,
    reset_config,
...
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.citations.models import (
    # Enumerations
    CitationType,
    SourceAuthority,
    RegulatoryFramework,
...
from greenlang.agents.foundation.citations.provenance import ProvenanceTracker, ProvenanceEntry
...
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.citations.setup import (
    CitationsService,
