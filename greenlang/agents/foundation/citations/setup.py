...
Usage:
    ...
    >>> from greenlang.agents.foundation.citations.setup import configure_citations_service
    >>> app = FastAPI()
...
from greenlang.agents.foundation.citations.config import CitationsConfig, get_config
from greenlang.agents.foundation.citations.registry import CitationRegistry
from greenlang.agents.foundation.citations.evidence import EvidenceManager
from greenlang.agents.foundation.citations.verification import VerificationEngine
from greenlang.agents.foundation.citations.provenance import ProvenanceTracker
from greenlang.agents.foundation.citations.export_import import ExportImportManager
from greenlang.agents.foundation.citations.metrics import PROMETHEUS_AVAILABLE
...
def configure_citations_service(
    ...
    try:
        from greenlang.agents.foundation.citations.api.router import router as citations_router
...
def get_router() -> Any:
    ...
    """
    try:
        from greenlang.agents.foundation.citations.api.router import router
        return router
    except ImportError:
        return None
