...
Example:
    >>> from greenlang.agents.foundation.access_guard import AccessGuardService
    >>> service = AccessGuardService()
    >>> service.startup()
    >>> result = service.check_access(access_request)
    >>> print(result.allowed)

    >>> from greenlang.agents.foundation.access_guard import PolicyEngine
    >>> engine = PolicyEngine()
...
# Configuration
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.access_guard.config import (
    AccessGuardConfig,
    get_config,
    set_config,
    reset_config,
...
from greenlang.agents.foundation.access_guard.provenance import ProvenanceTracker, ProvenanceEntry
...
# ---------------------------------------------------------------------------
from greenlang.agents.foundation.access_guard.setup import (
    AccessGuardService,
