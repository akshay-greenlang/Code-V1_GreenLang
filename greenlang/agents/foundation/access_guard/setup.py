...
Usage:
    ...
    >>> from greenlang.agents.foundation.access_guard.setup import configure_access_guard
    >>> app = FastAPI()
...
from greenlang.agents.foundation.access_guard.config import AccessGuardConfig, get_config
from greenlang.agents.foundation.access_guard.policy_engine import PolicyEngine
from greenlang.agents.foundation.access_guard.rate_limiter import RateLimiter
from greenlang.agents.foundation.access_guard.classifier import DataClassifier
from greenlang.agents.foundation.access_guard.audit_logger import AuditLogger
from greenlang.agents.foundation.access_guard.opa_integration import OPAClient
...
from greenlang.agents.foundation.access_guard.metrics import (
...
def configure_access_guard(
    ...
    # Mount API router
    try:
        from greenlang.agents.foundation.access_guard.api.router import router as guard_router
...
def get_router() -> Any:
    ...
    """
    try:
        from greenlang.agents.foundation.access_guard.api.router import router
        return router
    except ImportError:
        return None
