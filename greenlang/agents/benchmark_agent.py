...
class BenchmarkAgent(BaseAgent):
    ...
    def _generate_recommendations(self, rating: str, intensity: float, benchmarks: Dict) -> list:
        recommendations = []
        ...
        if reduction_needed > 0:
            ...
            recommendations.insert(0, f"Reduce emissions by {percent_reduction:.1f}% to achieve 'Good' rating")
