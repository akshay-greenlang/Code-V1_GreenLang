...
class EnergyBalanceAgent(BaseAgent):
    ...
    def execute(self, input_data: Dict[str, Any]) -> AgentResult:
        ...
        try:
            ...
            if not all([solar_resource_df_json, load_profile_df_json, required_aperture_area_m2 is not None]):
            ...
            def calculate_hourly_yield(row):
                ...
                thermal_loss_w = (THERMAL_LOSS_COEFF_U1 * delta_t + THERMAL_LOSS_COEFF_U2 * delta_t**2) * required_aperture_area_m2
            ...
            solar_fraction = total_heat_delivered / total_demand if total_demand > 0 else 0
