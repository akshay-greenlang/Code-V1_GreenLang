...
def _get_service():
    ...
    """
    from greenlang.agents.data.eudr_traceability.setup import EUDRTraceabilityService
...
async def register_plot(request: Dict[str, Any]):
    ...
    try:
        ...
        from greenlang.agents.data.eudr_traceability.models import RegisterPlotRequest
...
async def generate_dds(request: Dict[str, Any]):
    ...
    try:
        service = _get_service()
        from greenlang.agents.data.eudr_traceability.models import GenerateDDSRequest
...
async def assess_risk(request: Dict[str, Any]):
    ...
    try:
        service = _get_service()
        from greenlang.agents.data.eudr_traceability.models import AssessRiskRequest
...
async def classify_commodity(request: Dict[str, Any]):
    ...
    try:
        service = _get_service()
        from greenlang.agents.data.eudr_traceability.models import ClassifyCommodityRequest
