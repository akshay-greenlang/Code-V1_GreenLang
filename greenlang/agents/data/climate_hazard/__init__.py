...
Example:
    >>> from greenlang.agents.data.climate_hazard import ClimateHazardService
...
# ---------------------------------------------------------------------------
try:
    from greenlang.agents.data.climate_hazard.hazard_database import HazardDatabaseEngine
except ImportError:
    HazardDatabaseEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.data.climate_hazard.risk_index import RiskIndexEngine
except ImportError:
    RiskIndexEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.data.climate_hazard.scenario_projector import ScenarioProjectorEngine
except ImportError:
    ScenarioProjectorEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.data.climate_hazard.exposure_assessor import ExposureAssessorEngine
except ImportError:
    ExposureAssessorEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.data.climate_hazard.vulnerability_scorer import VulnerabilityScorerEngine
except ImportError:
    VulnerabilityScorerEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.data.climate_hazard.compliance_reporter import ComplianceReporterEngine
except ImportError:
