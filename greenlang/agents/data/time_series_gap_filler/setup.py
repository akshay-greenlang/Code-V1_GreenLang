...
Usage:
    ...
    >>> from greenlang.agents.data.time_series_gap_filler.setup import configure_gap_filler
    >>> app = FastAPI()
...
try:
    from greenlang.agents.data.time_series_gap_filler.metrics import PROMETHEUS_AVAILABLE
except ImportError:
