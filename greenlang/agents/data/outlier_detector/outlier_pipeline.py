...
Example:
    >>> from greenlang.agents.data.outlier_detector.outlier_pipeline import OutlierPipelineEngine
...
from greenlang.agents.data.outlier_detector.contextual_detector import ContextualDetectorEngine
...
from greenlang.agents.data.outlier_detector.multivariate_detector import MultivariateDetectorEngine
from greenlang.agents.data.outlier_detector.outlier_classifier import OutlierClassifierEngine
...
class OutlierPipelineEngine:
    ...
    def _ensemble_combine_from_batch(
        ...
        """
        from greenlang.agents.data.outlier_detector.models import DEFAULT_METHOD_WEIGHTS
