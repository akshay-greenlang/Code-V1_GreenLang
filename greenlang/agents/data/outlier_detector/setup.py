...
Usage:
    ...
    >>> from greenlang.agents.data.outlier_detector.setup import configure_outlier_detector
    >>> app = FastAPI()
    >>> import asyncio
...
class OutlierDetectorService:
    ...
    def _init_engines(self) -> None:
        ...
        try:
            from greenlang.agents.data.outlier_detector.contextual_detector import (
                ContextualDetectorEngine,
            )
        ...
        try:
            from greenlang.agents.data.outlier_detector.treatment_engine import (
                TreatmentEngine,
            )
...
async def configure_outlier_detector(
    ...
    try:
        from greenlang.agents.data.outlier_detector.api.router import router as od_router
