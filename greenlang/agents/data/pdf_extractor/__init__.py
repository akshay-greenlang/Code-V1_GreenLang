...
Example:
    >>> from greenlang.agents.data.pdf_extractor import PDFExtractorService
...
# Configuration
# ---------------------------------------------------------------------------
from greenlang.agents.data.pdf_extractor.config import (
    PDFExtractorConfig,
    get_config,
    set_config,
    reset_config,
...
# ---------------------------------------------------------------------------
from greenlang.agents.data.pdf_extractor.setup import (
    PDFExtractorService,
