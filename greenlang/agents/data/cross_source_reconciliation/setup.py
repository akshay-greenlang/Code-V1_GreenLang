...
Usage:
    ...
    >>> from greenlang.agents.data.cross_source_reconciliation.setup import configure_reconciliation
    >>> app = FastAPI()
...
try:
    from greenlang.agents.data.cross_source_reconciliation.metrics import PROMETHEUS_AVAILABLE
except ImportError:
