...
Example:
    >>> from greenlang.agents.data.excel_normalizer import ExcelNormalizerService
    >>> service = ExcelNormalizerService()
    >>> # Process an uploaded spreadsheet
    >>> from greenlang.agents.data.excel_normalizer import ExcelParser
    >>> parser = ExcelParser()
...
# Configuration
# ---------------------------------------------------------------------------
from greenlang.agents.data.excel_normalizer.config import (
...
# Models (enums, SDK)
# ---------------------------------------------------------------------------
from greenlang.agents.data.excel_normalizer.models import (
    # Enumerations
    FileFormat,
    DelimiterType,
    DataType,
...
# Core engines
# ---------------------------------------------------------------------------
from greenlang.agents.data.excel_normalizer.excel_parser import ExcelParser
from greenlang.agents.data.excel_normalizer.csv_parser import CSVParser
from greenlang.agents.data.excel_normalizer.column_mapper import ColumnMapper
from greenlang.agents.data.excel_normalizer.data_type_detector import DataTypeDetector
from greenlang.agents.data.excel_normalizer.schema_validator import SchemaValidator
from greenlang.agents.data.excel_normalizer.data_quality_scorer import DataQualityScorer
from greenlang.agents.data.excel_normalizer.transform_engine import TransformEngine
...
# ---------------------------------------------------------------------------
from greenlang.agents.data.excel_normalizer.setup import (
