...
Usage:
    ...
    >>> from greenlang.agents.data.deforestation_satellite.setup import configure_deforestation_satellite
    >>> app = FastAPI()
    >>> import asyncio
...
class DeforestationSatelliteService:
    ...
    def _init_engines(self) -> None:
        ...
        try:
            from greenlang.agents.data.deforestation_satellite.satellite_data import SatelliteDataEngine
        ...
        try:
            from greenlang.agents.data.deforestation_satellite.forest_change import ForestChangeEngine
        ...
        try:
            from greenlang.agents.data.deforestation_satellite.alert_aggregation import AlertAggregationEngine
        ...
        try:
            from greenlang.agents.data.deforestation_satellite.baseline_assessment import BaselineAssessmentEngine
        ...
        try:
            from greenlang.agents.data.deforestation_satellite.deforestation_classifier import DeforestationClassifierEngine
        ...
        try:
            from greenlang.agents.data.deforestation_satellite.compliance_report import ComplianceReportEngine
        ...
        try:
            from greenlang.agents.data.deforestation_satellite.monitoring_pipeline import MonitoringPipelineEngine
    ...
    def get_statistics(self) -> Any:
        ...
        from greenlang.agents.data.deforestation_satellite.models import DeforestationStatistics
...
async def configure_deforestation_satellite(
    ...
    # Mount API router
    try:
        from greenlang.agents.data.deforestation_satellite.api.router import router as deforestation_router
...
def get_router(service: Optional[DeforestationSatelliteService] = None) -> Any:
    ...
    """
    try:
        from greenlang.agents.data.deforestation_satellite.api.router import router
        return router
    except ImportError:
        return None
