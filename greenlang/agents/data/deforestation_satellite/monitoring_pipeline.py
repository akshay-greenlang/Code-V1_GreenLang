...
Example:
    ...
    >>> from greenlang.agents.data.deforestation_satellite.models import StartMonitoringRequest
...
class MonitoringPipelineEngine:
    ...
    def get_statistics(self) -> DeforestationStatistics:
        ...
        from greenlang.agents.data.deforestation_satellite.models import ComplianceStatus
