...
if FASTAPI_AVAILABLE:
    ...
    async def acquire_imagery(body: AcquireImageryBody, request: Request) -> Any:
        ...
        try:
            ...
            from greenlang.agents.data.deforestation_satellite.models import AcquireSatelliteRequest
    ...
    async def calculate_indices(body: CalculateIndicesBody, request: Request) -> Any:
        ...
        try:
            ...
            from greenlang.agents.data.deforestation_satellite.models import VegetationIndex
            index_enums = []
    ...
    async def detect_change(body: DetectChangeBody, request: Request) -> Any:
        ...
        try:
            service = _get_service(request)
            from greenlang.agents.data.deforestation_satellite.models import DetectChangeRequest
    ...
    async def filter_cutoff(body: FilterCutoffBody, request: Request) -> Any:
        ...
        try:
            ...
            from greenlang.agents.data.deforestation_satellite.models import DeforestationAlert
    ...
    async def check_baseline(body: CheckBaselineBody, request: Request) -> Any:
        ...
        try:
            service = _get_service(request)
            from greenlang.agents.data.deforestation_satellite.models import CheckBaselineRequest
    ...
    async def check_baseline_polygon(body: CheckBaselinePolygonBody, request: Request) -> Any:
        ...
        try:
            service = _get_service(request)
            from greenlang.agents.data.deforestation_satellite.models import CheckBaselinePolygonRequest
    ...
    async def generate_compliance_report(body: GenerateReportBody, request: Request) -> Any:
        ...
        try:
            ...
            if service.alert_engine is not None and polygon_coords:
                ...
                from greenlang.agents.data.deforestation_satellite.models import AlertAggregation
