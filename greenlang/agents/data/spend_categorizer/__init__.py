...
Example:
    >>> from greenlang.agents.data.spend_categorizer import SpendCategorizerService
...
# ---------------------------------------------------------------------------
from greenlang.agents.data.spend_categorizer.spend_ingestion import SpendIngestionEngine as RecordIngestionEngine
from greenlang.agents.data.spend_categorizer.taxonomy_classifier import TaxonomyClassifierEngine as TaxonomyClassifier
from greenlang.agents.data.spend_categorizer.scope3_mapper import Scope3MapperEngine as Scope3Mapper
from greenlang.agents.data.spend_categorizer.emission_factor import EmissionFactorEngine as EmissionCalculator
from greenlang.agents.data.spend_categorizer.category_rule import CategoryRuleEngine as RuleEngine
from greenlang.agents.data.spend_categorizer.spend_analytics import SpendAnalyticsEngine
from greenlang.agents.data.spend_categorizer.reporting import ReportingEngine as ReportGeneratorEngine
