...
Usage:
    ...
    >>> from greenlang.agents.data.data_freshness_monitor.setup import configure_freshness_monitor
    >>> app = FastAPI()
...
try:
    from greenlang.agents.data.data_freshness_monitor.alert_manager import (
        AlertManagerEngine,
    )
except ImportError:
...
try:
    from greenlang.agents.data.data_freshness_monitor.metrics import PROMETHEUS_AVAILABLE
except ImportError:
