...
Usage:
    ...
    >>> from greenlang.agents.data.schema_migration.setup import configure_schema_migration
    >>> app = FastAPI()
    >>> import asyncio
...
async def configure_schema_migration(
    ...
    try:
        from greenlang.agents.data.schema_migration.api.router import router as sm_router
