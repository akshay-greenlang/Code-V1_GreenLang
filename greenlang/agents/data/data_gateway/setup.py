...
class DataGatewayService:
    ...
    def __init__(self, config: Optional[Any] = None):
        ...
        from greenlang.agents.data.data_gateway.connection_manager import (
            ConnectionManagerEngine,
        )
        from greenlang.agents.data.data_gateway.response_aggregator import (
            ResponseAggregatorEngine,
        )
        from greenlang.agents.data.data_gateway.schema_translator import (
    ...
    def execute_query(self, request: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                from greenlang.agents.data.data_gateway.metrics import update_active_queries
...
def configure_data_gateway(app: Any) -> DataGatewayService:
    ...
    # Include router
    from greenlang.agents.data.data_gateway.api.router import router
