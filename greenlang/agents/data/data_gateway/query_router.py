...
class QueryRouterEngine:
    ...
    def route(
        ...
        try:
            from greenlang.agents.data.data_gateway.metrics import record_routing_decision
            for source_id in sources:
    ...
    def execute(
        ...
        # Record metrics
        try:
            from greenlang.agents.data.data_gateway.metrics import record_query
    ...
    def _execute_multi_source(
        ...
        try:
            from greenlang.agents.data.data_gateway.metrics import record_aggregation
    ...
    def _record_cb_failure(self, source_id: str) -> None:
        ...
        # Record metric
        try:
            from greenlang.agents.data.data_gateway.metrics import record_processing_error
