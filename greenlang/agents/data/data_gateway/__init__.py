...
Example:
    >>> from greenlang.agents.data.data_gateway import DataGatewayService
...
# Configuration
# ---------------------------------------------------------------------------
from greenlang.agents.data.data_gateway.config import (
    DataGatewayConfig,
    get_config,
    set_config,
    reset_config,
...
# ---------------------------------------------------------------------------
from greenlang.agents.data.data_gateway.models import (
    # Enumerations
    DataSourceType,
    QueryOperation,
    AggregationType,
...
# Core engines
# ---------------------------------------------------------------------------
from greenlang.agents.data.data_gateway.query_parser import QueryParserEngine
from greenlang.agents.data.data_gateway.query_router import QueryRouterEngine
from greenlang.agents.data.data_gateway.connection_manager import ConnectionManagerEngine
from greenlang.agents.data.data_gateway.response_aggregator import ResponseAggregatorEngine
from greenlang.agents.data.data_gateway.schema_translator import SchemaTranslatorEngine
from greenlang.agents.data.data_gateway.cache_manager import CacheManagerEngine
from greenlang.agents.data.data_gateway.data_catalog import DataCatalogEngine
from greenlang.agents.data.data_gateway.provenance import ProvenanceTracker

# ---------------------------------------------------------------------------
# Metrics
# ---------------------------------------------------------------------------
from greenlang.agents.data.data_gateway.metrics import (
...
# ---------------------------------------------------------------------------
from greenlang.agents.data.data_gateway.setup import (
    DataGatewayService,
