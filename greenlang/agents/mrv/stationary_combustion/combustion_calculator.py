...
Example:
    ...
    >>> from greenlang.agents.mrv.stationary_combustion.models import CombustionInput, UnitType, FuelType
...
from greenlang.agents.mrv.stationary_combustion.provenance import get_provenance_tracker
