...
if FASTAPI_AVAILABLE:
    ...
    def _get_service():
        ...
        """
        from greenlang.agents.mrv.stationary_combustion.setup import get_service
        svc = get_service()
        if svc is None:
            raise HTTPException(
                status_code=503,
    ...
    async def register_factor(body: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Fallback: in-memory registration
        from greenlang.agents.mrv.stationary_combustion.setup import _new_uuid, _compute_hash
    ...
    async def aggregate_calculations(body: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if svc._pipeline_engine is not None:
            from greenlang.agents.mrv.stationary_combustion.models import CalculationResult
            try:
    ...
    async def validate_inputs(body: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if svc._pipeline_engine is not None:
            ...
            from greenlang.agents.mrv.stationary_combustion.setup import _new_uuid
