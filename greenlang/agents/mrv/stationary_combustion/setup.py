...
Usage:
    ...
    >>> from greenlang.agents.mrv.stationary_combustion.setup import configure_stationary_combustion
    >>> app = FastAPI()
    >>> import asyncio
...
try:
    from greenlang.agents.mrv.stationary_combustion.calculator import CalculatorEngine
except ImportError:
    CalculatorEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.mrv.stationary_combustion.equipment_profiler import EquipmentProfilerEngine
except ImportError:
    EquipmentProfilerEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.mrv.stationary_combustion.factor_selector import FactorSelectorEngine
except ImportError:
    FactorSelectorEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.mrv.stationary_combustion.uncertainty import UncertaintyEngine
except ImportError:
    UncertaintyEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.mrv.stationary_combustion.audit import AuditEngine
except ImportError:
...
try:
    from greenlang.agents.mrv.stationary_combustion.provenance import ProvenanceTracker
except ImportError:
