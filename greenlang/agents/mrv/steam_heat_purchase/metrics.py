...
Example:
    ...
    >>> from greenlang.agents.mrv.steam_heat_purchase.metrics import SteamHeatPurchaseMetrics
    ...
    >>> from greenlang.agents.mrv.steam_heat_purchase.metrics import get_metrics
    >>> m = get_metrics()
...
def reset() -> None:
    ...
    **Testing only.**  Resets both the module-level cached reference
    ...
    Example:
        >>> from greenlang.agents.mrv.steam_heat_purchase.metrics import reset
