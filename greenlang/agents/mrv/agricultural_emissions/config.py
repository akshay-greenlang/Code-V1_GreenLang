...
Example:
    >>> from greenlang.agents.mrv.agricultural_emissions.config import get_config
    >>> cfg = get_config()
    >>> print(cfg.default_gwp_source, cfg.default_calculation_method)
    AR6 IPCC_TIER_1

    >>> # Override for testing
    >>> from greenlang.agents.mrv.agricultural_emissions.config import set_config, reset_config
    >>> from greenlang.agents.mrv.agricultural_emissions.config import AgriculturalEmissionsConfig
