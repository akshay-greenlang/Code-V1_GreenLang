...
try:
    ...
    logger.warning(
        "greenlang.agents.mrv.capital_goods.models not available; "
...
try:
    ...
    logger.warning(
        "greenlang.agents.mrv.capital_goods.config not available; "
        "using defaults"
    )
...
try:
    ...
    logger.warning(
        "greenlang.agents.mrv.capital_goods.metrics not available; "
...
try:
    ...
    logger.warning(
        "greenlang.agents.mrv.capital_goods.provenance not available; "
