...
Example:
    >>> from greenlang.agents.mrv.capital_goods.average_data_calculator import AverageDataCalculatorEngine
    >>> from greenlang.agents.mrv.capital_goods.models import PhysicalRecord, AssetCategory
