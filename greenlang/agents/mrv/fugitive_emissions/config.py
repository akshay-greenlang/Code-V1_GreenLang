...
Example:
    >>> from greenlang.agents.mrv.fugitive_emissions.config import get_config
    >>> cfg = get_config()
    >>> print(cfg.default_gwp_source, cfg.default_calculation_method)
    AR6 AVERAGE_EMISSION_FACTOR

    >>> # Override for testing
    >>> from greenlang.agents.mrv.fugitive_emissions.config import set_config, reset_config
