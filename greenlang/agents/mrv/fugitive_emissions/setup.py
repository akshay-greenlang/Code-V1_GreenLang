...
Usage:
    ...
    >>> from greenlang.agents.mrv.fugitive_emissions.setup import configure_fugitive_emissions
    >>> app = FastAPI()
    >>> configure_fugitive_emissions(app)

    >>> from greenlang.agents.mrv.fugitive_emissions.setup import get_service
    >>> svc = get_service()
