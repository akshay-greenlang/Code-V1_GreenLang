...
Module: greenlang.agents.mrv.audit_trail_lineage.audit_trail_pipeline
Agent: AGENT-MRV-030
Version: 1.0.0
...
class AuditTrailPipelineEngine:
    ...
    def _get_audit_event_engine(self) -> Any:
        ...
        if self._audit_event_engine is None:
            try:
                from greenlang.agents.mrv.audit_trail_lineage.audit_event import (
                    AuditEventEngine,
                )
    ...
    def _get_lineage_graph_engine(self) -> Any:
        ...
        if self._lineage_graph_engine is None:
            try:
                from greenlang.agents.mrv.audit_trail_lineage.lineage_graph import (
                    LineageGraphEngine,
                )
    ...
    def _get_compliance_tracer_engine(self) -> Any:
        ...
        if self._compliance_tracer_engine is None:
            try:
                from greenlang.agents.mrv.audit_trail_lineage.compliance_tracer import (
    ...
    def _get_change_detector_engine(self) -> Any:
        ...
        if self._change_detector_engine is None:
            try:
                from greenlang.agents.mrv.audit_trail_lineage.change_detector import (
    ...
    def _get_evidence_packager_engine(self) -> Any:
        ...
        if self._evidence_packager_engine is None:
            try:
                from greenlang.agents.mrv.audit_trail_lineage.evidence_packager import (
    ...
    def _get_metrics(self) -> Any:
        ...
        if self._metrics is None:
            try:
                from greenlang.agents.mrv.audit_trail_lineage.metrics import get_metrics
