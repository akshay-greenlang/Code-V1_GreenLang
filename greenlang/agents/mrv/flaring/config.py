...
Example:
    >>> from greenlang.agents.mrv.flaring.config import get_config
    >>> cfg = get_config()
    >>> print(cfg.default_gwp_source, cfg.default_combustion_efficiency)
    AR6 0.98

    >>> # Override for testing
    >>> from greenlang.agents.mrv.flaring.config import set_config, reset_config
    >>> from greenlang.agents.mrv.flaring.config import FlaringConfig
