...
Example:
    >>> from greenlang.agents.mrv.flaring import FlaringConfig
    >>> from greenlang.agents.mrv.flaring import get_config
    >>> cfg = get_config()
...
# Provenance
# ---------------------------------------------------------------------------
from greenlang.agents.mrv.flaring.provenance import (
    ProvenanceTracker,
    ProvenanceEntry,
    ProvenanceChain,
    VALID_ENTITY_TYPES,
...
# ---------------------------------------------------------------------------
try:
    from greenlang.agents.mrv.flaring.models import (
...
try:
    from greenlang.agents.mrv.flaring.flaring_event_tracker import FlaringEventTrackerEngine
except ImportError:
    FlaringEventTrackerEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.mrv.flaring.uncertainty_quantifier import UncertaintyQuantifierEngine
except ImportError:
    UncertaintyQuantifierEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.mrv.flaring.flaring_pipeline import FlaringPipelineEngine
except ImportError:
    FlaringPipelineEngine = None  # type: ignore[assignment, misc]

try:
    from greenlang.agents.mrv.flaring.flaring_pipeline import PIPELINE_STAGES
except ImportError:
...
# ---------------------------------------------------------------------------
try:
    from greenlang.agents.mrv.flaring.setup import (
        FlaringService,
        configure_flaring,
        get_service,
        get_router,
