...
try:
    from greenlang.agents.mrv.scope2_market.config import get_config as _get_config
...
try:
    from greenlang.agents.mrv.scope2_market.metrics import get_metrics as _get_metrics
