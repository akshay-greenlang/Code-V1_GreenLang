...
Example:
    >>> from greenlang.agents.mrv.land_use_emissions.config import get_config
    >>> cfg = get_config()
    >>> print(cfg.default_gwp_source, cfg.default_method)
    AR6 STOCK_DIFFERENCE

    >>> # Override for testing
    >>> from greenlang.agents.mrv.land_use_emissions.config import set_config, reset_config
