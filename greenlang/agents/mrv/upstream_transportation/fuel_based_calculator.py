...
Example:
    >>> from greenlang.agents.mrv.upstream_transportation.fuel_based_calculator import (
...
try:
    ...
    logger.warning(
        "greenlang.agents.mrv.upstream_transportation.models not available; "
        "using inline fallback constants"
    )

try:
    from greenlang.agents.mrv.upstream_transportation.config import get_config as _get_config
