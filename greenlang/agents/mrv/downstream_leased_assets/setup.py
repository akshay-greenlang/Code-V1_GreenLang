...
Example:
    >>> from greenlang.agents.mrv.downstream_leased_assets.setup import get_service
    >>> service = get_service()
...
Integration:
    >>> from greenlang.agents.mrv.downstream_leased_assets.setup import get_router
...
class DownstreamLeasedAssetsService:
    ...
    def __init__(self) -> None:
        ...
        self._database_engine = self._init_engine(
            "greenlang.agents.mrv.downstream_leased_assets.downstream_asset_database",
            "DownstreamAssetDatabaseEngine",
        )
        self._asset_specific_engine = self._init_engine(
            "greenlang.agents.mrv.downstream_leased_assets.asset_specific_calculator",
            "AssetSpecificCalculatorEngine",
        )
        self._average_data_engine = self._init_engine(
            "greenlang.agents.mrv.downstream_leased_assets.average_data_calculator",
            "AverageDataCalculatorEngine",
        )
        self._spend_engine = self._init_engine(
            "greenlang.agents.mrv.downstream_leased_assets.spend_based_calculator",
            "SpendBasedCalculatorEngine",
        )
        self._hybrid_engine = self._init_engine(
            "greenlang.agents.mrv.downstream_leased_assets.hybrid_aggregator",
            "HybridAggregatorEngine",
        )
        self._compliance_engine = self._init_engine(
            "greenlang.agents.mrv.downstream_leased_assets.compliance_checker",
            "ComplianceCheckerEngine",
        )
        self._pipeline_engine = self._init_engine(
            "greenlang.agents.mrv.downstream_leased_assets.downstream_leased_assets_pipeline",
...
def get_router():
    ...
    """
    from greenlang.agents.mrv.downstream_leased_assets.api.router import router
    return router
