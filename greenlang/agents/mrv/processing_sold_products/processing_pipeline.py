...
Example:
    >>> from greenlang.agents.mrv.processing_sold_products.processing_pipeline import ProcessingPipelineEngine
...
Module: greenlang.agents.mrv.processing_sold_products.processing_pipeline
