...
Example:
    >>> from greenlang.agents.mrv.end_of_life_treatment.setup import get_service
    >>> service = get_service()
...
Integration:
    >>> from greenlang.agents.mrv.end_of_life_treatment.setup import get_router
...
class EndOfLifeTreatmentService:
    ...
    def __init__(self) -> None:
        ...
        self._database_engine = self._init_engine(
            "greenlang.agents.mrv.end_of_life_treatment.eol_product_database",
            "EOLProductDatabaseEngine",
        )
        self._waste_type_engine = self._init_engine(
            "greenlang.agents.mrv.end_of_life_treatment.waste_type_specific_calculator",
            "WasteTypeSpecificCalculatorEngine",
        )
        self._average_data_engine = self._init_engine(
            "greenlang.agents.mrv.end_of_life_treatment.average_data_calculator",
            "AverageDataCalculatorEngine",
        )
        self._producer_specific_engine = self._init_engine(
            "greenlang.agents.mrv.end_of_life_treatment.producer_specific_calculator",
            "ProducerSpecificCalculatorEngine",
        )
        self._hybrid_engine = self._init_engine(
            "greenlang.agents.mrv.end_of_life_treatment.hybrid_aggregator",
            "HybridAggregatorEngine",
        )
        self._compliance_engine = self._init_engine(
            "greenlang.agents.mrv.end_of_life_treatment.compliance_checker",
            "ComplianceCheckerEngine",
        )
        self._pipeline_engine = self._init_engine(
            "greenlang.agents.mrv.end_of_life_treatment.end_of_life_treatment_pipeline",
    ...
    def calculate_average_data(self, request: AverageDataCalculationRequest) -> SingleTreatmentResponse:
        ...
        start_time = time.monotonic()
        try:
            from greenlang.agents.mrv.end_of_life_treatment.end_of_life_treatment_pipeline import AVERAGE_DATA_EFS
    ...
    def get_material_ef(self, request: MaterialEFRequest) -> MaterialEFResponse:
        ...
        """
        try:
            from greenlang.agents.mrv.end_of_life_treatment.end_of_life_treatment_pipeline import MATERIAL_TREATMENT_EFS
    ...
    def get_product_composition(self, category: str) -> ProductCompositionResponse:
        ...
        """
        try:
            from greenlang.agents.mrv.end_of_life_treatment.end_of_life_treatment_pipeline import DEFAULT_PRODUCT_BOMS
    ...
    def get_regional_treatment_mix(self, region: str) -> RegionalTreatmentMixResponse:
        ...
        """
        try:
            from greenlang.agents.mrv.end_of_life_treatment.end_of_life_treatment_pipeline import REGIONAL_TREATMENT_MIXES
    ...
    def get_product_weight_default(self, category: str) -> Dict[str, Any]:
        ...
        """
        try:
            from greenlang.agents.mrv.end_of_life_treatment.end_of_life_treatment_pipeline import DEFAULT_PRODUCT_WEIGHTS
...
def get_router():
    ...
    """
    from greenlang.agents.mrv.end_of_life_treatment.api.router import router
    return router
