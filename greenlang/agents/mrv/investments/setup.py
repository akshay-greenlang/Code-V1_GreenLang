...
Example:
    >>> from greenlang.agents.mrv.investments.setup import get_service
    >>> service = get_service()
...
Integration:
    >>> from greenlang.agents.mrv.investments.setup import get_router
    >>> app.include_router(get_router(), prefix="/api/v1/investments")

Module: greenlang.agents.mrv.investments.setup
Agent: AGENT-MRV-028
Version: 1.0.0
"""
...
class InvestmentsService:
    ...
    def __init__(self) -> None:
        ...
        self._database_engine = self._init_engine(
            "greenlang.agents.mrv.investments.investment_database",
            "InvestmentDatabaseEngine",
        )
        self._equity_engine = self._init_engine(
            "greenlang.agents.mrv.investments.equity_investment_calculator",
            "EquityInvestmentCalculatorEngine",
        )
        self._debt_engine = self._init_engine(
            "greenlang.agents.mrv.investments.debt_investment_calculator",
            "DebtInvestmentCalculatorEngine",
        )
        self._real_asset_engine = self._init_engine(
            "greenlang.agents.mrv.investments.real_asset_calculator",
            "RealAssetCalculatorEngine",
        )
        self._sovereign_engine = self._init_engine(
            "greenlang.agents.mrv.investments.sovereign_bond_calculator",
            "SovereignBondCalculatorEngine",
        )
        self._compliance_engine = self._init_engine(
            "greenlang.agents.mrv.investments.compliance_checker",
            "ComplianceCheckerEngine",
        )
        self._pipeline_engine = self._init_engine(
            "greenlang.agents.mrv.investments.investments_pipeline",
    ...
    def get_sector_factors(self) -> CarbonIntensityResponse:
        ...
        """
        from greenlang.agents.mrv.investments.investments_pipeline import _SECTOR_EFS
    ...
    def get_country_factors(self) -> EmissionFactorResponse:
        ...
        """
        from greenlang.agents.mrv.investments.investments_pipeline import _COUNTRY_GRID_EFS
    ...
    def get_pcaf_quality(self) -> PCafQualityResponse:
        ...
        """
        from greenlang.agents.mrv.investments.compliance_checker import PCAF_DQ_DESCRIPTIONS
