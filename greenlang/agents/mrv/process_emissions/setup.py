...
Usage:
    ...
    >>> from greenlang.agents.mrv.process_emissions.setup import configure_process_emissions
    >>> app = FastAPI()
    >>> configure_process_emissions(app)

    >>> from greenlang.agents.mrv.process_emissions.setup import get_service
    >>> svc = get_service()
