...
Example:
    >>> from greenlang.agents.mrv.mobile_combustion.config import get_config
    >>> cfg = get_config()
    >>> print(cfg.default_gwp_source, cfg.default_calculation_method)
    AR6 FUEL_BASED

    >>> # Override for testing
    >>> from greenlang.agents.mrv.mobile_combustion.config import set_config, reset_config
    >>> from greenlang.agents.mrv.mobile_combustion.config import MobileCombustionConfig
