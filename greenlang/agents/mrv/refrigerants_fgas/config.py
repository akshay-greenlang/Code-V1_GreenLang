...
Example:
    >>> from greenlang.agents.mrv.refrigerants_fgas.config import get_config
    >>> cfg = get_config()
    >>> print(cfg.default_gwp_source, cfg.default_gwp_timeframe)
    AR6 100yr

    >>> # Override for testing
    >>> from greenlang.agents.mrv.refrigerants_fgas.config import set_config, reset_config
    >>> from greenlang.agents.mrv.refrigerants_fgas.config import RefrigerantsFGasConfig
