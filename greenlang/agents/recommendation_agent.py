...
class RecommendationAgent(BaseAgent):
        ...
        try:
            ...
            return AgentResult(
                ...
                data={
                    ...
                    "implementation_roadmap": self._create_roadmap(unique_recommendations),
    ...
    def _calculate_savings_potential(self, recommendations: List[Dict], 
                                    emissions_by_source: Dict) -> Dict:
