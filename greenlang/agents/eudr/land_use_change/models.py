...
class LandUseClassification(GreenLangBase):
...
class LandUseTransition(GreenLangBase):
...
class TransitionMatrix(GreenLangBase):
...
class TemporalTrajectory(GreenLangBase):
...
class CroplandConversion(GreenLangBase):
...
class ConversionRisk(GreenLangBase):
...
class UrbanEncroachment(GreenLangBase):
...
class ClassificationRequest(GreenLangBase):
...
class TransitionRequest(GreenLangBase):
...
class TrajectoryRequest(GreenLangBase):
...
class VerificationRequest(GreenLangBase):
...
class TransitionResponse(GreenLangBase):
