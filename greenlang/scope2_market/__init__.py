...
def __getattr__(name):
    _exports = {
        "ContractualInstrumentDatabaseEngine": "greenlang.scope2_market.contractual_instrument_database",
        "InstrumentAllocationEngine": "greenlang.scope2_market.instrument_allocation",
        "MarketEmissionsCalculatorEngine": "greenlang.scope2_market.market_emissions_calculator",
        "DualReportingEngine": "greenlang.scope2_market.dual_reporting",
        "UncertaintyQuantifierEngine": "greenlang.scope2_market.uncertainty_quantifier",
        "ComplianceCheckerEngine": "greenlang.scope2_market.compliance_checker",
        "Scope2MarketPipelineEngine": "greenlang.scope2_market.scope2_market_pipeline",
        "Scope2MarketConfig": "greenlang.scope2_market.config",
        "Scope2MarketMetrics": "greenlang.scope2_market.metrics",
        "Scope2MarketProvenance": "greenlang.scope2_market.provenance",
        "Scope2MarketService": "greenlang.scope2_market.setup",
        "get_service": "greenlang.scope2_market.setup",
    }
    if name in _exports:
        import importlib
