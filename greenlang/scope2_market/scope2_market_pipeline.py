...
def _lazy_import_engines() -> None:
    ...
    if _InstrumentDatabaseEngine is None:
        try:
            from greenlang.scope2_market.instrument_database import (
    ...
    if _CoveredEmissionsEngine is None:
        try:
            from greenlang.scope2_market.covered_emissions import (
    ...
    if _ResidualMixEngine is None:
        try:
            from greenlang.scope2_market.residual_mix import (
                ResidualMixEngine,
            )
