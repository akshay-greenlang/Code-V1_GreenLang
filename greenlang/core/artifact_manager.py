...
class ArtifactManager:
    ...
    def __init__(self, base_dir: Optional[Path] = None, storage_type: ArtifactStorage = ArtifactStorage.LOCAL):
        """
        ...
        if self.storage_type == ArtifactStorage.LOCAL and self.metadata_dir.exists():
            for metadata_file in self.metadata_dir.glob("*.json"):
                try:
                    ...
                    storage_path = self.base_dir / data.get('storage_path', metadata.artifact_id)
    ...
    def _generate_artifact_id(self, name: str, context: Optional[Dict[str, Any]] = None) -> str:
    ...
    def _detect_artifact_type(self, file_path: Path, hint: Optional[ArtifactType] = None) -> ArtifactType:
    ...
    def create_artifact(self,
                       ...
                       properties: Optional[Dict[str, Any]] = None) -> Artifact:
        """
    ...
    def get_artifacts_by_type(self, artifact_type: ArtifactType) -> List[Artifact]:
        ...
        return [a for a in self.artifacts.values() if a.metadata.artifact_type == artifact_type]
    ...
    def get_artifacts_by_pipeline(self, pipeline_id: str) -> List[Artifact]:
        ...
        return [a for a in self.artifacts.values() if a.metadata.pipeline_id == pipeline_id]
    ...
    def search_artifacts(self, 
                        ...
                        tags: Optional[Dict[str, str]] = None,
                        properties: Optional[Dict[str, Any]] = None) -> List[Artifact]:
    ...
    def get_lineage(self, artifact_id: str, direction: str = "both") -> Dict[str, List[str]]:
        """
    ...
    def delete_artifact(self, artifact_id: str) -> bool:
        ...
        # Remove from storage
        if self.storage_type == ArtifactStorage.LOCAL and artifact.storage_path.exists():
    ...
    def import_metadata(self, input_file: Path) -> int:
        ...
        for data in metadata_list:
            try:
                ...
                print(f"Warning: Could not import artifact {data.get('artifact_id')}: {e}")
