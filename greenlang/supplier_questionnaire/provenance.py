...
Provides SHA-256 based audit trail tracking for all supplier questionnaire
...
Example:
    ...
    >>> entry_id = tracker.record("template", "tpl_001", "create", "abc123")
    >>> valid, chain = tracker.verify_chain("tpl_001")
...
class ProvenanceTracker:
    """Tracks provenance for supplier questionnaire operations with SHA-256 chain hashing.
    ...
    _GENESIS_HASH = hashlib.sha256(b"greenlang-supplier-questionnaire-genesis").hexdigest()
