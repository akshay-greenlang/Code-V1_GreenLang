...
Provides SHA-256 based audit trail tracking for all Excel & CSV
normalization operations. Maintains an in-memory chain-hashed operation
...
Example:
    ...
    >>> entry_id = tracker.record("file", "file_001", "upload", "abc123")
    >>> valid, chain = tracker.verify_chain("file_001")
...
class ProvenanceTracker:
    ...
    def record(
        ...
        Args:
            entity_type: Type of entity (file, sheet, mapping, job, etc.).
            entity_id: Unique entity identifier.
            action: Action performed (upload, parse, map, normalize, etc.).
