...
try:
    from greenlang.upstream_transportation.transport_database import TransportDatabaseEngine
except ImportError:
    TransportDatabaseEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.upstream_transportation.distance_based_calculator import DistanceBasedCalculatorEngine
except ImportError:
    DistanceBasedCalculatorEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.upstream_transportation.fuel_based_calculator import FuelBasedCalculatorEngine
except ImportError:
    FuelBasedCalculatorEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.upstream_transportation.spend_based_calculator import SpendBasedCalculatorEngine
except ImportError:
    SpendBasedCalculatorEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.upstream_transportation.multi_leg_calculator import MultiLegCalculatorEngine
except ImportError:
    MultiLegCalculatorEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.upstream_transportation.compliance_checker import ComplianceCheckerEngine
except ImportError:
    ComplianceCheckerEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.upstream_transportation.transport_pipeline import TransportPipelineEngine
except ImportError:
