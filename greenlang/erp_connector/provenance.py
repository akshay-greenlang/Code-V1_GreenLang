...
Provides SHA-256 based audit trail tracking for all ERP connector
...
Example:
    ...
    >>> entry_id = tracker.record("connection", "conn_001", "register", "abc123")
    >>> valid, chain = tracker.verify_chain("conn_001")
...
class ProvenanceTracker:
    """Tracks provenance for ERP connector operations with SHA-256 chain hashing.
    ...
    _GENESIS_HASH = hashlib.sha256(b"greenlang-erp-connector-genesis").hexdigest()
    ...
    def record(
        ...
        Args:
            entity_type: Type of entity (connection, sync, spend, emission, etc.).
            entity_id: Unique entity identifier.
            action: Action performed (register, sync, map, calculate, etc.).
