...
try:
    ...
    logger.warning(
        "greenlang.purchased_goods_services.config not available; "
        "using defaults"
    )
...
try:
    ...
    logger.warning(
        "greenlang.purchased_goods_services.metrics not available; "
...
try:
    ...
    logger.warning(
        "greenlang.purchased_goods_services.provenance not available; "
