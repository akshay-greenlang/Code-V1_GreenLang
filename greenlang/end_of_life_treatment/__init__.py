...
try:
    from greenlang.end_of_life_treatment.eol_product_database import EOLProductDatabaseEngine
except ImportError:
    EOLProductDatabaseEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.end_of_life_treatment.waste_type_specific_calculator import WasteTypeSpecificCalculatorEngine
except ImportError:
    WasteTypeSpecificCalculatorEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.end_of_life_treatment.average_data_calculator import AverageDataCalculatorEngine
except ImportError:
    AverageDataCalculatorEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.end_of_life_treatment.producer_specific_calculator import ProducerSpecificCalculatorEngine
except ImportError:
    ProducerSpecificCalculatorEngine = None  # type: ignore[assignment,misc]

try:
    from greenlang.end_of_life_treatment.hybrid_aggregator import HybridAggregatorEngine
except ImportError:
