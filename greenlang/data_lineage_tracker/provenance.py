...
Provides SHA-256 based audit trail tracking for all data lineage
...
Zero-Hallucination Guarantees:
    ...
    - Complete provenance for every data lineage operation
...
class ProvenanceEntry:
    ...
    Attributes:
        entity_type: Type of entity being tracked (lineage_asset,
            transformation, lineage_edge, impact_analysis, validation,
            report, change_event, quality_score).
        entity_id: Unique identifier for the entity instance.
        action: Action performed (asset_registered, transformation_captured,
            edge_created, impact_analyzed, validation_completed,
            report_generated, change_detected, quality_scored).
