...
try:
    from greenlang.steam_heat_purchase.metrics import get_metrics as _get_metrics
...
try:
    from greenlang.steam_heat_purchase.steam_heat_database import SteamHeatDatabaseEngine
    _DB_AVAILABLE = True
except ImportError:
    _DB_AVAILABLE = False
