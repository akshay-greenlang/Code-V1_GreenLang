...
class StructuredLogger:
    ...
    def _log(self, level: LogLevel, message: str, data: Dict[str, Any],
...
class LogAggregator:
    ...
    def __init__(self, max_logs: int = 10000):
        ...
        self.log_counts: Dict[str, Dict[str, int]] = defaultdict(lambda: defaultdict(int))
    ...
    def add_log(self, entry: LogEntry):
        ...
        with self._lock:
            ...
            # Update counts
            self.log_counts[entry.level.value][entry.context.component or "unknown"] += 1
        ...
        with self._lock:
            ...
            for error_type, error_list in error_groups.items():
                summary[error_type] = {
                    ...
                    "latest": error_list[-1].timestamp.isoformat() if error_list else None,
                    "components": list(set(
                        e.context.component for e in error_list 
