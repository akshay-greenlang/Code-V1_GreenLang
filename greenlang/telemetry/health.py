...
class HealthChecker:
    ...
    async def check_health_async(self, check_type: Optional[CheckType] = None) -> HealthReport:
        """
    ...
    def get_status(self) -> HealthStatus:
        ...
        return self._calculate_overall_status(
            list(self._last_check_results.values())
        )
    ...
    def _calculate_overall_status(self, results: List[HealthCheckResult]) -> HealthStatus:
        ...
        critical_checks = [r for r in results if self.checks.get(r.name, None) and self.checks[r.name].critical]
