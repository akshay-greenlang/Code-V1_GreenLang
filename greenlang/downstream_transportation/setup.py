...
Example:
    >>> from greenlang.downstream_transportation.setup import get_service
    >>> service = get_service()
...
Integration:
    >>> from greenlang.downstream_transportation.setup import get_router
    >>> app = FastAPI()
...
class DownstreamTransportService:
    ...
    def __init__(self) -> None:
        ...
        self._database_engine = self._init_engine(
            "greenlang.downstream_transportation.downstream_transport_database",
            "DownstreamTransportDatabaseEngine",
        )
        self._distance_engine = self._init_engine(
            "greenlang.downstream_transportation.distance_based_calculator",
            "DistanceBasedCalculatorEngine",
        )
        self._spend_engine = self._init_engine(
            "greenlang.downstream_transportation.spend_based_calculator",
            "SpendBasedCalculatorEngine",
        )
        self._average_data_engine = self._init_engine(
            "greenlang.downstream_transportation.average_data_calculator",
            "AverageDataCalculatorEngine",
        )
        self._warehouse_engine = self._init_engine(
            "greenlang.downstream_transportation.warehouse_distribution",
            "WarehouseDistributionEngine",
        )
        self._compliance_engine = self._init_engine(
            "greenlang.downstream_transportation.compliance_checker",
            "ComplianceCheckerEngine",
        )
        self._pipeline_engine = self._init_engine(
            "greenlang.downstream_transportation.downstream_transport_pipeline",
...
def get_router():
    ...
    """
    from greenlang.downstream_transportation.api.router import router
    return router
