...
Example:
    >>> from greenlang.employee_commuting.setup import get_service
    >>> service = get_service()
...
Integration:
    >>> from greenlang.employee_commuting.setup import get_router
...
class EmployeeCommutingService:
    ...
    def _calc_vanpool(
        ...
        """
        try:
            from greenlang.employee_commuting.models import VAN_EMISSION_FACTORS
...
def get_router():
    ...
    """
    from greenlang.employee_commuting.api.router import router
