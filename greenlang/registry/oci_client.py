...
class OCIManifest:
    ...
    def from_json(cls, data: str) -> 'OCIManifest':
        ...
        return cls(
            ...
            media_type=obj.get("mediaType", "application/vnd.oci.image.manifest.v1+json"),
...
class OCIAuth:
    ...
    def get_auth_header(self, registry: str, scope: Optional[str] = None) -> Optional[str]:
    ...
    def _request_bearer_token(self, realm: str, service: Optional[str], 
...
class OCIClient:
    ...
    def push_blob(self, namespace: str, name: str, data: bytes,
                 media_type: str = "application/octet-stream") -> OCIDescriptor:
        """
    ...
    def push_manifest(self, namespace: str, name: str, tag: str,
                     manifest: OCIManifest) -> str:
        """
    ...
    def push_pack(self, namespace: str, name: str, tag: str,
                 pack_path: Path, annotations: Optional[Dict[str, str]] = None) -> str:
        """
    ...
    def pull_pack(self, namespace: str, name: str, reference: str,
