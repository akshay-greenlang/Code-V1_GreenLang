...
class AgentBuilder:
    ...
    def with_execute(self, func: Callable[[Dict[str, Any]], AgentResult]) -> "AgentBuilder":
    ...
    def with_preprocessing(self, func: Callable[[Dict[str, Any]], Dict[str, Any]]) -> "AgentBuilder":
        self.preprocess_func = func
        return self
    
    def with_postprocessing(self, func: Callable[[AgentResult], AgentResult]) -> "AgentBuilder":
...
class WorkflowBuilder:
    ...
    def add_step(self, name: str, agent_id: str, description: Optional[str] = None) -> "WorkflowBuilder":
        step = WorkflowStep(
            name=name,
            agent_id=agent_id,
