...
Example:
    >>> from greenlang.scope3_category_mapper.setup import get_service
    >>> service = get_service()
...
Integration:
    >>> from greenlang.scope3_category_mapper.setup import get_router
    >>> app.include_router(get_router(), prefix="/api/v1/scope3-category-mapper")

Module: greenlang.scope3_category_mapper.setup
Agent: AGENT-MRV-029
Version: 1.0.0
"""
