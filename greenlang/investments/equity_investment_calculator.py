...
def _get_metrics_collector() -> Any:
    ...
    try:
        from greenlang.investments.metrics import get_metrics_collector
...
def _get_provenance_manager() -> Any:
    ...
    try:
        from greenlang.investments.provenance import get_provenance_manager
...
def _get_database_engine() -> Any:
    ...
    try:
        from greenlang.investments.investment_database import get_database_engine
