...
class HubClient:
    ...
    def push(self, 
        ...
        try:
            ...
            logger.error(f"Failed to push pack: {e.response.status_code} - {e.response.text}")
            raise
    ...
    def pull(self, 
        ...
        try:
            ...
            logger.error(f"Failed to pull pack: {e.response.status_code} - {e.response.text}")
            raise
        except Exception as e:
    ...
    def get_pack_info(self, pack_ref: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(f"Failed to get pack info: {e.response.status_code} - {e.response.text}")
            raise
        except Exception as e:
    ...
    def delete_pack(self, pack_ref: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to delete pack: {e.response.status_code} - {e.response.text}")
            raise
        except Exception as e:
