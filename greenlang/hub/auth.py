...
class HubAuth:
    ...
    def login(self, username: str, password: str, 
              registry_url: str = "https://hub.greenlang.io") -> bool:
        """
    ...
    def refresh_token(self, registry_url: str = "https://hub.greenlang.io") -> bool:
        ...
        try:
            ...
            response = httpx.post(
                f"{registry_url}/api/v1/auth/refresh",
    ...
    def create_api_key(self, name: str, 
                      registry_url: str = "https://hub.greenlang.io") -> Optional[str]:
        """
        Create new API key
    ...
    def _save_credentials(self):
        ...
        try:
            ...
            if KEYRING_AVAILABLE:
                ...
                if self.username:
                    keyring.set_password(self.KEYRING_SERVICE, "username", self.username)
                if self.api_key:
...
class PackSigner:
    ...
    def verify_signature(self, pack_data: bytes, signature: Dict[str, Any],
