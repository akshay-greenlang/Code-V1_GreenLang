    ...
    def create_resource_quota(tenant_id: str, quota: TenantQuota) -> Dict[str, Any]:
        ...
        return {
            ...
            "metadata": {
                ...
                "namespace": TenantIsolation.get_namespace(tenant_id, IsolationLevel.NAMESPACE)
            },
            "spec": {
                "hard": {
                    ...
                    "pods": str(quota.max_concurrent_pipelines * 5)  # Assuming 5 pods per pipeline
                }
            }
        }
...
class TenantManager:
    ...
    def create_token(self, tenant_id: str, user_id: str,
                    roles: List[str] = None,
        ...
        claims = {
            ...
            "limits": {
                "cpu": tenant.quota.max_cpu,
                "memory": tenant.quota.max_memory
            },
    ...
    def _create_isolation_resources(self, tenant: Tenant):
        ...
        # Create namespace
        namespace = TenantIsolation.get_namespace(tenant.tenant_id, tenant.isolation_level)
        logger.info(f"Creating namespace: {namespace}")
        
        # Create resource quota
        quota_manifest = TenantIsolation.create_resource_quota(tenant.tenant_id, tenant.quota)
