...
Provides SHA-256 based audit trail tracking for all EUDR traceability
...
Example:
    ...
    >>> entry_id = tracker.record("plot", "PLOT-abc123", "register", "abc123")
...
class ProvenanceTracker:
    """Tracks provenance for EUDR traceability operations with SHA-256 chain hashing.
    ...
    _GENESIS_HASH = hashlib.sha256(b"greenlang-eudr-traceability-genesis").hexdigest()

    # Valid operation types for EUDR traceability
    ...
    def __init__(self) -> None:
        ...
        logger.info("ProvenanceTracker initialized (agent=%s)", self.AGENT_ID)
    ...
    def record(
        ...
        Args:
            entity_type: Type of entity (plot, transfer, dds, risk, etc.).
            entity_id: Unique entity identifier.
            action: Action performed (register, transfer, generate, etc.).
