...
def __getattr__(name):
    _exports = {
        "GridEmissionFactorDatabaseEngine": "greenlang.scope2_location.grid_factor_database",
        "ElectricityEmissionsEngine": "greenlang.scope2_location.electricity_emissions",
        "SteamHeatCoolingEngine": "greenlang.scope2_location.steam_heat_cooling",
        "TransmissionLossEngine": "greenlang.scope2_location.transmission_loss",
        "UncertaintyQuantifierEngine": "greenlang.scope2_location.uncertainty_quantifier",
        "ComplianceCheckerEngine": "greenlang.scope2_location.compliance_checker",
        "Scope2LocationPipelineEngine": "greenlang.scope2_location.scope2_location_pipeline",
        "Scope2LocationConfig": "greenlang.scope2_location.config",
        "Scope2LocationMetrics": "greenlang.scope2_location.metrics",
        "Scope2LocationProvenance": "greenlang.scope2_location.provenance",
        "Scope2LocationService": "greenlang.scope2_location.setup",
        "get_service": "greenlang.scope2_location.setup",
    }
    if name in _exports:
        import importlib
