# -*- coding: utf-8 -*-
"""
Report Generator for GL-001 ThermalCommand Explainability Module.
...
class ReportMetadata:
    ...
    report_type: str
    version: str = "1.0.0"
    generator: str = "GL-001 ThermalCommand Explainability Module"
...
class ReportGenerator:
    """
    Generates explanation reports for GL-001 ThermalCommand.
    ...
    def _generate_metadata(
        ...
        return {
            ...
            "generator": "GL-001 ThermalCommand Explainability Module",
            "version": "1.0.0",
            "deterministic": True
        }
