# =============================================================================
# GreenLang Staging Environment - Tempo Storage
# GreenLang Climate OS | OBS-003
# =============================================================================
#
# Tempo trace storage configuration for the staging environment.
# Moderate retention matching pre-production debugging needs.
#
# Key characteristics:
# - 60-day trace retention (longer than dev for regression analysis)
# - IA transition after 21 days
...
module "tempo_storage" {
  ...
  # Moderate retention for staging - 60 days total, IA at 21 days
  retention_days     = 60
  ia_transition_days = 21
