...
def http_get(url: str, *, tag: str = "unknown", timeout: int = 30, **kwargs) -> requests.Response:
    """
...
def http_post(url: str, data: Optional[Dict[str, Any]] = None, *, 
              tag: str = "unknown", timeout: int = 30, **kwargs) -> requests.Response:
    """
...
def download_file(url: str, dest: Path, *, tag: str = "download", 
