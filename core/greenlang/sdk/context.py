...
class Context:
    ...
    def save_artifact(self, name: str, content: Any, type: str = "json", **metadata) -> Artifact:
    ...
    def get_all_step_outputs(self) -> Dict[str, Any]:
        ...
        return {name: step["outputs"] for name, step in self.steps.items() if "outputs" in step}
    ...
    def to_result(self) -> Result:
        ...
        return Result(
            ...
            metadata={
                ...
                "artifacts": [a.model_dump() if hasattr(a, 'model_dump') else a.dict() for a in self.artifacts.values()]
            }
        )
