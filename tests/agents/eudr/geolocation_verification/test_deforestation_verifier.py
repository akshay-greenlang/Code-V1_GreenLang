...
class TestVerificationStatus:
    ...
    def test_verified_forest_intact(self, deforestation_verifier):
        ...
        coord = VerifyCoordinateRequest(lat=-3.12, lon=-60.02, declared_country="BR")
        result = deforestation_verifier.verify(coord)
        assert isinstance(result, DeforestationVerificationResult)
    ...
    def test_deforestation_detected_post_cutoff(self, deforestation_verifier):
        ...
        coord = VerifyCoordinateRequest(lat=-9.5, lon=-56.0, declared_country="BR")
        result = deforestation_verifier.verify(coord)
        assert isinstance(result, DeforestationVerificationResult)
    ...
    def test_inconclusive_insufficient_data(self, deforestation_verifier):
        ...
        coord = VerifyCoordinateRequest(lat=-10.0, lon=-70.0, declared_country="BR")
        result = deforestation_verifier.verify(coord)
        assert isinstance(result, DeforestationVerificationResult)
...
class TestConfidenceScoring:
    ...
    def test_confidence_score_range(self, deforestation_verifier):
        ...
        coords = [
            VerifyCoordinateRequest(lat=-3.12, lon=-60.02, declared_country="BR"),
            VerifyCoordinateRequest(lat=-15.78, lon=-47.93, declared_country="BR"),
            VerifyCoordinateRequest(lat=-2.57, lon=111.77, declared_country="ID"),
        ]
        for coord in coords:
            result = deforestation_verifier.verify(coord)
            assert 0.0 <= result.confidence <= 1.0
    ...
    def test_confidence_score_low_agreement(self, deforestation_verifier):
        ...
        coord = VerifyCoordinateRequest(lat=-5.0, lon=-55.0, declared_country="BR")
        result = deforestation_verifier.verify(coord)
        assert isinstance(result.confidence, float)
...
class TestCutoffDate:
    ...
    def test_cutoff_date_format(self, deforestation_verifier, cutoff):
        ...
        coord = VerifyCoordinateRequest(lat=-3.12, lon=-60.02)
        result = deforestation_verifier.verify(coord)
...
class TestBatchDeforestation:
    ...
    def test_batch_single(self, deforestation_verifier):
        ...
        coords = [VerifyCoordinateRequest(lat=-3.12, lon=-60.02, declared_country="BR")]
        results = deforestation_verifier.verify_batch(coords)
    ...
    def test_batch_preserves_order(self, deforestation_verifier):
        ...
        coords = [
            ...
            VerifyCoordinateRequest(lat=-15.78, lon=-47.93, plot_id="P2"),
    ...
    def test_batch_mixed_results(self, deforestation_verifier):
        ...
        coords = [
            VerifyCoordinateRequest(lat=-15.78, lon=-47.93, declared_country="BR"),   # Urban
            VerifyCoordinateRequest(lat=-3.12, lon=-60.02, declared_country="BR"),    # Forest
            VerifyCoordinateRequest(lat=-2.57, lon=111.77, declared_country="ID"),    # Indonesia
        ]
        results = deforestation_verifier.verify_batch(coords)
...
class TestDeforestationDeterminism:
    ...
    def test_different_coords_may_differ(self, deforestation_verifier):
        ...
        c1 = VerifyCoordinateRequest(lat=-3.12, lon=-60.02, declared_country="BR")
        c2 = VerifyCoordinateRequest(lat=-15.78, lon=-47.93, declared_country="BR")
