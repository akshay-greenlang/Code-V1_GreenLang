"""
GL-FOUND-X-003: GreenLang Normalizer SDK - Synchronous Client

This module provides the synchronous NormalizerClient for interacting with
the GreenLang Unit & Reference Normalizer API.
...
class NormalizerClient:
    """
    Synchronous client for the GreenLang Normalizer API.

    This client provides methods for normalizing units, resolving entities,
    ...
    Example:
        ...
        >>> from gl_normalizer import ClientConfig
    ...
    def __init__(
        ...
        self._client = httpx.Client(
            ...
            headers={
                ...
                "User-Agent": "gl-normalizer-sdk/0.1.0",
            },
    ...
    def close(self) -> None:
        ...
        self._client.close()
        self._cache.clear()
        logger.debug("NormalizerClient closed")
    ...
    def _make_request(
        ...
        # POST requests with same data can also be cached
        if use_cache and method.upper() == "POST" and data:
    ...
    def normalize(
        ...
        **context: Any,
        ...
        """
        Normalize a single measurement value.
        ...
        Example:
            ...
            >>> # With metadata
            >>> from gl_normalizer import NormalizeMetadata, ReferenceConditions
            >>> metadata = NormalizeMetadata(
            ...     reference_conditions=ReferenceConditions(temperature_c=0)
            ... )
            >>> result = client.normalize(250, "Nm3", metadata=metadata)
        """
        ...
        # Extract first measurement result
    ...
    def normalize_batch(
        ...
        """
        Normalize a batch of measurements (up to 10K items).
        ...
        response = self._make_request("POST", "/normalize/batch", data=request_data)
    ...
    def create_job(
        ...
        response = self._make_request("POST", "/jobs", data=request_data)
    ...
    def wait_for_job(
        ...
        Example:
            >>> job = client.create_job(requests)
            >>> completed_job = client.wait_for_job(job.job_id, timeout=3600)
    ...
    def resolve_entity(
        ...
        """
        Resolve a raw entity name to a reference ID.
    ...
    def list_vocabularies(
        ...
        Example:
            ...
            >>> # Filter by type
            >>> fuel_vocabs = client.list_vocabularies(entity_type="fuel")
        """
        params: Dict[str, Any] = {}
        if entity_type:
            if isinstance(entity_type, str):
    ...
    def get_vocabulary(
        ...
        Example:
            >>> vocab = client.get_vocabulary("fuels", version="2026.01.0")
