...
class HealthCheckManager:
    ...
    async def check_database_health(self, use_cache: bool = True) -> ComponentHealth:
        ...
        try:
            ...
            self._db_cache.expires_at = datetime.now() + timedelta(seconds=self.readiness_cache_ttl_seconds)
            ...
            self._db_cache.result = result
            self._db_cache.expires_at = datetime.now() + timedelta(seconds=2)
    ...
    async def check_redis_health(self, use_cache: bool = True) -> ComponentHealth:
        ...
        try:
            ...
            self._redis_cache.expires_at = datetime.now() + timedelta(seconds=self.readiness_cache_ttl_seconds)
            ...
            self._redis_cache.result = result
            self._redis_cache.expires_at = datetime.now() + timedelta(seconds=2)
    ...
    async def check_llm_health(self, use_cache: bool = True) -> ComponentHealth:
        ...
        try:
            ...
            self._llm_cache.expires_at = datetime.now() + timedelta(seconds=self.readiness_cache_ttl_seconds)
            ...
            self._llm_cache.result = result
            self._llm_cache.expires_at = datetime.now() + timedelta(seconds=2)
    ...
    async def check_vector_db_health(self, use_cache: bool = True) -> ComponentHealth:
        ...
        try:
            ...
            self._vector_db_cache.expires_at = datetime.now() + timedelta(seconds=self.readiness_cache_ttl_seconds)
            ...
            self._vector_db_cache.result = result
            self._vector_db_cache.expires_at = datetime.now() + timedelta(seconds=2)
