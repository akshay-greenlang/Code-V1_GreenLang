...
class HeatRecoveryOrchestrator(BaseAgent):
    ...
    async def generate_implementation_plan(self, optimization_data: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        phase1 = {
            ...
            "milestones": [
                {"milestone": "Complete energy audit", "date": datetime.now() + timedelta(days=30)},
                {"milestone": "Install first heat exchanger", "date": datetime.now() + timedelta(days=90)},
                {"milestone": "Commission quick win projects", "date": datetime.now() + timedelta(days=150)}
            ],
            "risks": [
        ...
        phase2 = {
            ...
            "end_date": datetime.now() + timedelta(days=540),
            "activities": [
                {
            ...
            "milestones": [
                {"milestone": "Complete detailed engineering", "date": datetime.now() + timedelta(days=240)},
                {"milestone": "Procure major equipment", "date": datetime.now() + timedelta(days=360)},
                {"milestone": "Complete installation", "date": datetime.now() + timedelta(days=480)},
                {"milestone": "Start commercial operation", "date": datetime.now() + timedelta(days=540)}
            ],
            "risks": [
        ...
        phase3 = {
            ...
            "milestones": [
                {"milestone": "Complete control system upgrade", "date": datetime.now() + timedelta(days=600)},
                {"milestone": "Commission ORC system", "date": datetime.now() + timedelta(days=690)},
                {"milestone": "Achieve full optimization", "date": datetime.now() + timedelta(days=720)}
            ],
            "risks": [
