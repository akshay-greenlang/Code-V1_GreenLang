...
class KPICalculator:
    ...
    def _calculate_energy_kpis(
        ...
        return {
            ...
            'total_energy_consumed_mwh': float(total_energy / Decimal('1000'))
        }
    ...
    def _calculate_production_kpis(
        ...
        return {
            ...
            'defect_rate_ppm': float(defect_ppm.quantize(Decimal('1'))),
    ...
    def _calculate_financial_kpis(
        ...
        return {
            ...
            'cost_per_mwh_usd': float(cost_per_mwh.quantize(Decimal('0.01'))),
    ...
    def _calculate_environmental_kpis(
        ...
        return {
            ...
            'total_co2_emissions_tonnes': float(co2)
        }
    ...
    def _calculate_maintenance_kpis(
        ...
        return {
            ...
            'total_downtime_hours': float(scheduled + unscheduled)
        }
