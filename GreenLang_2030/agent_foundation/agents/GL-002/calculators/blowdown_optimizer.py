...
class BlowdownOptimizer:
    ...
    def calculate_optimal_blowdown(self, data: BlowdownData) -> Dict:
        ...
        result = {
            ...
            'current_blowdown_percent': float(current_rate),
            'optimal_blowdown_percent': float(optimal_rate),
            'current_blowdown_kg_hr': float(Decimal(str(data.steam_flow_rate_kg_hr)) * current_rate / Decimal('100')),
            'optimal_blowdown_kg_hr': float(Decimal(str(data.steam_flow_rate_kg_hr)) * optimal_rate / Decimal('100')),
    ...
    def _calculate_water_losses(
        ...
        losses = {
            ...
            'annual_cost_savings': float(cost_savings)
        }
    ...
    def _calculate_energy_losses(
        ...
        losses = {
            ...
            'annual_cost_savings': float(energy_cost_savings),
    ...
    def _calculate_heat_recovery(
        ...
        recovery = {
            ...
            'total_recovery_kw': float(total_recovery),
            'recovery_efficiency_percent': float(total_recovery / (blowdown_flow * Decimal('2.5')) * Decimal('100')),
