...
class TestEN12952Compliance:
    ...
    def test_inspection_requirements(self, compliance_validator):
        ...
        inspection_data = {
            "last_hydraulic_test": datetime.now() - timedelta(days=365),
            "last_internal_inspection": datetime.now() - timedelta(days=180),
            "last_external_inspection": datetime.now() - timedelta(days=90),
