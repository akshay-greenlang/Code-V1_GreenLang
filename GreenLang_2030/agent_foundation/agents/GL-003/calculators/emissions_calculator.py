...
class EmissionsCalculator:
    ...
    def calculate_emissions(
        ...
        return EmissionsResult(
            ...
            co2_emissions_tonnes=float(co2_kg / Decimal('1000')),
            nox_emissions_kg=float(nox_kg),
            sox_emissions_kg=float(sox_kg),
            emission_intensity_kg_co2_per_gj=float(emission_intensity),
