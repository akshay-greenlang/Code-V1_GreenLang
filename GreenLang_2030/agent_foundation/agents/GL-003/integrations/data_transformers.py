...
def main():
    ...
    raw_data = [
        ...
        {'timestamp': datetime.utcnow() - timedelta(minutes=5), 'value': 103, 'unit': 'psi', 'source': 'sensor1'},
        {'timestamp': datetime.utcnow() - timedelta(minutes=4), 'value': 104, 'unit': 'psi', 'source': 'sensor1'},
        {'timestamp': datetime.utcnow() - timedelta(minutes=3), 'value': 106, 'unit': 'psi', 'source': 'sensor1'},
        {'timestamp': datetime.utcnow() - timedelta(minutes=2), 'value': 104, 'unit': 'psi', 'source': 'sensor1'},
        {'timestamp': datetime.utcnow() - timedelta(minutes=1), 'value': 105, 'unit': 'psi', 'source': 'sensor1'},
    ]
