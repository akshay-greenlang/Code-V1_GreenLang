...
class TestDataGenerator:
    ...
    def generate_cbam_shipment(
        ...
        shipment = {
            ...
            "origin_country": random.choice(["CN", "IN", "RU", "TR", "UA"]),
            "destination_port": random.choice(["Rotterdam", "Hamburg", "Antwerp"]),
    ...
    def generate_cbam_batch(
        ...
        for i in range(count):
            with_errors = random.random() < error_rate
    ...
    def generate_fuel_consumption(
        ...
        for _ in range(num_fuels):
            ...
            fuel_record = {
                ...
                "combustion_type": random.choice(["stationary", "mobile"]),
    ...
    def generate_scope3_emissions(
        ...
        return {
            ...
            "verification_status": random.choice(["verified", "pending", "in_review"]),
    ...
    def generate_supply_chain_data(
        ...
        for i in range(num_suppliers):
            supplier = {
                ...
                "sustainability_rating": random.choice(["A", "B", "C", "D", "E"]),
                "products": []
            }

            # Add 3-10 products per supplier
            num_supplier_products = random.randint(3, min(10, num_products))
            for j in range(num_supplier_products):
                product = {
                    "product_id": f"PROD-{random.randint(1000, 9999)}",
                    "name": self.faker.word().capitalize() + " " + random.choice(["Widget", "Component", "Material"]),
                    "category": random.choice(["raw_material", "component", "finished_good"]),
    ...
    def generate_load_test_data(
        ...
        for i in range(num_records):
            if record_type == "emission":
                ...
                record = {"id": i, "value": random.random()}
