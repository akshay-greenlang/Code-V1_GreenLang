...
from core.greenlang.policy.enforcer import PolicyEnforcer, check_install, check_run
from core.greenlang.utils.net import http_get, policy_allow, add_allowed_domain
from core.greenlang.sdk.pipeline import Pipeline
...
def test_policy_files():
    ...
    from core.greenlang.policy.opa import _check_opa_installed, validate_policy
